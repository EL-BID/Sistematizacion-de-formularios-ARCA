/*
	...
	License: http://imperavi.com/redactor/license/aaaaa
			...
			return {
				...
				formatWrap: function(tag)
				{
					...
					if (this.opts.linebreaks)
					{
						...
						if ($next.lenght != 0 && $next[0].tagName === 'BR')
						{
							$next.remove();
						}
					}
			...
			return {
				...
				insert: function(cmd)
				{
					...
					if (this.utils.isEmpty($list.find('li').text()))
					{
						...
						if (this.opts.linebreaks && this.utils.browser('mozilla') && $children.lenght == 2 && this.utils.isEmpty($children.eq(1).text()))
						{
