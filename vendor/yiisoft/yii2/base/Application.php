...
abstract class Application extends Module
{
    ...
    /*Formato para fechas se declara un formato definido para todas las fechas segun base de datos
     * TO_DATE(campo,'dd/MM/yyyy') , este mismo formato se usa para los datepicker en las vistas
     */
    public $fmtfechasql = 'yyyy/MM/dd';
    
    /*Formato para fechas segun php consultar http://php.net/manual/es/function.date.php
     * 2018-05-10 "Y-m-d"
     * 10-05-2018 "d-m-Y"
     * Este formato se utilizara cuando se invoque a la funcion date o gmdate
     */
    
    public $fmtfechaphp = 'Y/m/d';
    
    public $fmtfechahoraphp = 'Y/m/d H:i:s';
    
    public $fmtfechahoradatepicker = 'yyyy/mm/dd hh:ii:ss';
    /**
