...
class StringValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->max !== null && $this->tooLong === null) {
            $this->tooLong = Yii::t('yii', '{attribute} debe contener como m&aacute;ximo {max, number} {max, plural, one{character} other{characters}}.');
        }
        if ($this->length !== null && $this->notEqual === null) {
            $this->notEqual = Yii::t('yii', '{attribute} deber&iacute;a contener {length, number} {length, plural, one{character} other{characters}}.');
        }
    }
    ...
    public function getClientOptions($model, $attribute)
    {
        ...
        if ($this->skipOnEmpty) {
			...
			Yii::trace("paso por aqui ".$options['skipOnEmpty'],"DEBUG");
        }else{
            $options['skipOnEmpty'] = '';
        }
