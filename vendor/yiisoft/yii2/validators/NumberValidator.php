...
class NumberValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->message === null) {
            $this->message = $this->integerOnly ? Yii::t('yii', '{attribute} debe ser un entero.')
                : Yii::t('yii', '{attribute} debe ser un entero.');
        }
        if ($this->min !== null && $this->tooSmall === null) {
            $this->tooSmall = Yii::t('yii', '{attribute} no debe ser menor que {min}.');
        }
        if ($this->max !== null && $this->tooBig === null) {
            $this->tooBig = Yii::t('yii', '{attribute} no debe ser mayor que {max}.');
        }
    }
