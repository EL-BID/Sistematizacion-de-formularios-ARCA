...
/**
 * UsuariosApControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo UsuariosAp.
 */
class UsuariosApControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
