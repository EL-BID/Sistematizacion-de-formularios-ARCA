...
use common\models\autenticacion\MenusSearch;
...
/**
 * MenuControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo Menus.
 */
class MenuControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Encuentra el modelo de Menus basado en el valor de la primary key.
     * Si no encuentra respuesta, arroja una excepcion 404 HTTP.
     * @param integer $id
     * @return Menus el modelo cargado
    ...
    {
        if (($model = Menus::findAll($params)) !== null) {
            return $model;
        }
        else{
            return null;
    ...
    /**
     * Funcion visible para los objetos que necesiten una consulta al modelo Menus     
     * @param type $params contiene array con valores de query a columnas de la tabla
     * @return type Menus     */
     public function cargaMenus($params){
