...
use backend\models\autenticacion\TipoEntidadSearch;
...
/**
 * TipoEntidadController implementa las acciones a través del sistema CRUD para el modelo TipoEntidad.
 */
class TipoEntidadController extends Controller
{
    ...
    /**
     * Listado todos los datos del modelo TipoEntidad que se encuentran en el tablename.
     * @return mixed
     */
    ...
    /**
     * Presenta un dato unico en el modelo TipoEntidad.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Crea un nuevo dato sobre el modelo TipoEntidad .
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return	$this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_tipo_entidad]);
    ...
    /**
     * Modifica un dato existente en el modelo TipoEntidad.
