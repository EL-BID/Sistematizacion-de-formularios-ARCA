...
/**
 * TarTareaProgramadaController implementa las acciones a través del sistema CRUD para el modelo TarTareaProgramada.
 */
class TarTareaProgramadaController extends ControllerPry
{
  //private $facade =    TarTareaProgramadaControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  TarTareaProgramadaControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_tarea_programada]);		
