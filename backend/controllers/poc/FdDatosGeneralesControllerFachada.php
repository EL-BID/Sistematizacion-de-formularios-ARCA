...
/**
 * FdDatosGeneralesControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdDatosGenerales.
 */
class FdDatosGeneralesControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    {
                $searchModel = new FdDatosGeneralesSearch();
    ...
    /**
     * Finds the FdDatosGenerales model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return FdDatosGenerales the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
                    if (($model = FdDatosGenerales::findOne($id)) !== null) {
                        return $model;
                    } else {
