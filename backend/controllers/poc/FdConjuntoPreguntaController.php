...
/**
 * FdConjuntoPreguntaController implementa las acciones a través del sistema CRUD para el modelo FdConjuntoPregunta.
 */
class FdConjuntoPreguntaController extends ControllerPry
{
  //private $facade =    FdConjuntoPreguntaControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdConjuntoPreguntaControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_conjunto_pregunta]);		
