...
/**
 * FdElementoCondicionController implementa las acciones a través del sistema CRUD para el modelo FdElementoCondicion.
 */
class FdElementoCondicionController extends ControllerPry
{
  //private $facade =    FdElementoCondicionControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdElementoCondicionControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_condicion]);		
