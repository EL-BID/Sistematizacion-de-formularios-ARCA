...
/**
 * FdTipoViewCapController implementa las acciones a través del sistema CRUD para el modelo FdTipoViewCap.
 */
class FdTipoViewCapController extends ControllerPry
{
  //private $facade =    FdTipoViewCapControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdTipoViewCapControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_tview_cap]);		
