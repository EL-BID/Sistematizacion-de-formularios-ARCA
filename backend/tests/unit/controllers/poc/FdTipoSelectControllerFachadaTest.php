...
use Yii;
use backend\controllers\poc\FdTipoSelectControllerFachada;
/**
 * FdTipoSelectControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdTipoSelect.
 */
class FdTipoSelectControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdTipoSelectControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\FdTipoSelectControllerFachada', $tester);
    ...
    /**
     * Presenta un dato unico en el modelo FdTipoSelect.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Crea un nuevo dato sobre el modelo FdTipoSelect .
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\FdTipoSelectControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdTipoSelectControllerFachada' => [
                                'id_tselect' => 'Ingresar valor de pruebas para el campo id_tselect de tipo int4',
                             'nom_tselect' => 'Ingresar valor de pruebas para el campo nom_tselect de tipo varchar',
                          ]];
     ...
     /**
     * Modifica un dato existente en el modelo FdTipoSelect.
    ...
    public function testActionUpdate($id)
    {
     ...
     /**
     * Deletes an existing FdTipoSelect model.
