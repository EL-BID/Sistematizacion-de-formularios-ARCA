...
use Yii;
use backend\controllers\poc\FdTipoCapituloControllerFachada;
/**
 * FdTipoCapituloControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdTipoCapitulo.
 */
class FdTipoCapituloControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdTipoCapituloControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\FdTipoCapituloControllerFachada', $tester);
    ...
    /**
     * Presenta un dato unico en el modelo FdTipoCapitulo.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Crea un nuevo dato sobre el modelo FdTipoCapitulo .
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\FdTipoCapituloControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdTipoCapituloControllerFachada' => [
                                'id_tcapitulo' => "4",       
     ...
     /**
     * Modifica un dato existente en el modelo FdTipoCapitulo.
    ...
    public function testActionUpdate($id)
    {
     ...
     /**
     * Deletes an existing FdTipoCapitulo model.
