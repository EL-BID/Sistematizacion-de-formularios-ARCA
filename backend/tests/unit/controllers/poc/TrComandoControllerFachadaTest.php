...
/**
 * TrComandoControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo TrComando.
 */
class TrComandoControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  TrComandoControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\TrComandoControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\TrComandoControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['TrComandoControllerFachada' => [
                                'id_comando' => 'Ingresar valor de pruebas para el campo id_comando de tipo int4',
                             'nom_comando' => 'Ingresar valor de pruebas para el campo nom_comando de tipo varchar',
                             'clase_comando' => 'Ingresar valor de pruebas para el campo clase_comando de tipo varchar',
                             'hash_comando' => 'Ingresar valor de pruebas para el campo hash_comando de tipo varchar',
