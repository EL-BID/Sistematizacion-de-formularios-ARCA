...
use Yii;
use backend\controllers\poc\FdComandoController;


/**
 * FdComandoControllerTest implementa las acciones a través del sistema CRUD para el modelo FdFormato.
 */
class FdComandoControllerTest extends \Codeception\Test\Unit
{
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdComandoController('FdComandoController','backend\controllers\poc\FdComandoController');
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\FdComandoController', $tester);
    ...
    public function testActionIndex()
    {
        ...
        $actionIndex=Yii::$app->runAction('FdComandoController/index');
    ...
    {       
        ...
        // se deben declarar los valores de $id para enviar la llave
            ...
            $actionView=Yii::$app->runAction('FdComandoController/view',['id' => $id]);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\FdComandoController', $tester);
            ...
            $queryParams = ['FdComandoController' => [
                                             'id_formato' => "Ingresar valor de pruebas para el campo id_formato de tipo int4",       
                                              'nom_formato' => "Ingresar valor de pruebas para el campo nom_formato de tipo varchar",       
                                              'num_formato' => "Ingresar valor de pruebas para el campo num_formato de tipo varchar",       
                                              'id_tipo_view_formato' => "Ingresar valor de pruebas para el campo id_tipo_view_formato de tipo int4",       
       ...
       //       Se declaran el post1
            ...
            $actionCreate=Yii::$app->runAction('FdComandoController/create');
    ...
    public function testActionUpdate($id)
    {
        ...
        $actionUpdate=Yii::$app->runAction('FdComandoController/update',['id' => $id]);
    ...
    public function testActionDeletep($id)
    {
        ...
        // se valida que se pueda realizar el borrado del registro
         $actionDelete=Yii::$app->runAction(FdComandoController/update',['id' => $id]);
