...
/**
 * FdTipoAgrupacionControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdTipoAgrupacion.
 */
class FdTipoAgrupacionControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdTipoAgrupacionControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\FdTipoAgrupacionControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\FdTipoAgrupacionControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdTipoAgrupacionControllerFachada' => [
                                'id_tagrupacion' => 'Ingresar valor de pruebas para el campo id_tagrupacion de tipo int4',
                             'nom_tagrupacion' => 'Ingresar valor de pruebas para el campo nom_tagrupacion de tipo varchar',
                          ]];
