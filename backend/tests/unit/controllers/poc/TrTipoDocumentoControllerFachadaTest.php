...
use Yii;
use backend\controllers\poc\TrTipoDocumentoControllerFachada;
/**
 * TrTipoDocumentoControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo TrTipoDocumento.
 */
class TrTipoDocumentoControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  TrTipoDocumentoControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\TrTipoDocumentoControllerFachada', $tester);
    ...
    /**
     * Presenta un dato unico en el modelo TrTipoDocumento.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Crea un nuevo dato sobre el modelo TrTipoDocumento .
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\TrTipoDocumentoControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['TrTipoDocumentoControllerFachada' => [
                                'id_tdocumento' => 'Ingresar valor de pruebas para el campo id_tdocumento de tipo int4',
                             'nom_tdocumento' => 'Ingresar valor de pruebas para el campo nom_tdocumento de tipo varchar',
                          ]];
     ...
     /**
     * Modifica un dato existente en el modelo TrTipoDocumento.
    ...
    public function testActionUpdate($id)
    {
     ...
     /**
     * Deletes an existing TrTipoDocumento model.
