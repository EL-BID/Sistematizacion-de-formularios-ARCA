...
use Yii;
use backend\controllers\poc\FdTipoPreguntaControllerFachada;
/**
 * FdTipoPreguntaControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdTipoPregunta.
 */
class FdTipoPreguntaControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdTipoPreguntaControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\FdTipoPreguntaControllerFachada', $tester);
    ...
    /**
     * Presenta un dato unico en el modelo FdTipoPregunta.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Crea un nuevo dato sobre el modelo FdTipoPregunta .
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\FdTipoPreguntaControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdTipoPreguntaControllerFachada' => [
                                'id_tpregunta' => 'Ingresar valor de pruebas para el campo id_tpregunta de tipo int4',
                             'nom_tpregunta' => 'Ingresar valor de pruebas para el campo nom_tpregunta de tipo varchar',
                             'pantalla_lectura' => 'Ingresar valor de pruebas para el campo pantalla_lectura de tipo varchar',
                             'url_subpantalla' => 'Ingresar valor de pruebas para el campo url_subpantalla de tipo varchar',
     ...
     /**
     * Modifica un dato existente en el modelo FdTipoPregunta.
    ...
    public function testActionUpdate($id)
    {
     ...
     /**
     * Deletes an existing FdTipoPregunta model.
