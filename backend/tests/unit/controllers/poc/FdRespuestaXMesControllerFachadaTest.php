...
/**
 * FdRespuestaXMesControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdRespuestaXMes.
 */
class FdRespuestaXMesControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdRespuestaXMesControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\FdRespuestaXMesControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\FdRespuestaXMesControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdRespuestaXMesControllerFachada' => [
                                'ene_decimal' => 'Ingresar valor de pruebas para el campo ene_decimal de tipo numeric',
                             'feb_decimal' => 'Ingresar valor de pruebas para el campo feb_decimal de tipo numeric',
                             'mar_decimal' => 'Ingresar valor de pruebas para el campo mar_decimal de tipo numeric',
                             'abr_decimal' => 'Ingresar valor de pruebas para el campo abr_decimal de tipo numeric',
