...
/**
 * TrTipoCoordenadaControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo TrTipoCoordenada.
 */
class TrTipoCoordenadaControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  TrTipoCoordenadaControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\TrTipoCoordenadaControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\TrTipoCoordenadaControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['TrTipoCoordenadaControllerFachada' => [
                                'id_tcoordenada' => 'Ingresar valor de pruebas para el campo id_tcoordenada de tipo int4',
                             'nom_tcoordenada' => 'Ingresar valor de pruebas para el campo nom_tcoordenada de tipo varchar',
                          ]];
