...
use Yii;
use backend\controllers\poc\FdHistoricoRespuestaControllerFachada;
/**
 * FdHistoricoRespuestaControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdHistoricoRespuesta.
 */
class FdHistoricoRespuestaControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdHistoricoRespuestaControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\FdHistoricoRespuestaControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\FdHistoricoRespuestaControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdHistoricoRespuestaControllerFachada' => [
                                'id_historico_respuesta' => 'Ingresar valor de pruebas para el campo id_historico_respuesta de tipo int4',
                             'observaciones' => 'Ingresar valor de pruebas para el campo observaciones de tipo varchar',
                             'fecha' => 'Ingresar valor de pruebas para el campo fecha de tipo date',
                             'usuario' => 'Ingresar valor de pruebas para el campo usuario de tipo varchar',
