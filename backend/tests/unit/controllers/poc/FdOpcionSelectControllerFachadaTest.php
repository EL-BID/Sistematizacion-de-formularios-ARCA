...
/**
 * FdOpcionSelectControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdOpcionSelect.
 */
class FdOpcionSelectControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdOpcionSelectControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\FdOpcionSelectControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\FdOpcionSelectControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdOpcionSelectControllerFachada' => [
                                'id_opcion_select' => 'Ingresar valor de pruebas para el campo id_opcion_select de tipo int4',
                             'nom_opcion_select' => 'Ingresar valor de pruebas para el campo nom_opcion_select de tipo varchar',
                             'orden' => 'Ingresar valor de pruebas para el campo orden de tipo int4',
                             'id_tselect' => 'Ingresar valor de pruebas para el campo id_tselect de tipo int4',
