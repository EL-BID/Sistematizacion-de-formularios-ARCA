...
use Yii;
use backend\controllers\poc\FdCapituloControllerFachada;
/**
 * FdCapituloControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdCapitulo.
 */
class FdCapituloControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdCapituloControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\FdCapituloControllerFachada', $tester);
    ...
    /**
     * Presenta un dato unico en el modelo FdCapitulo.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Crea un nuevo dato sobre el modelo FdCapitulo .
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\FdCapituloControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdCapituloControllerFachada' => [
                                'id_capitulo' => 'Ingresar valor de pruebas para el campo id_capitulo de tipo int4',
                             'nom_capitulo' => 'Ingresar valor de pruebas para el campo nom_capitulo de tipo varchar',
                             'orden' => 'Ingresar valor de pruebas para el campo orden de tipo int4',
                             'url' => 'Ingresar valor de pruebas para el campo url de tipo varchar',
     ...
     /**
     * Modifica un dato existente en el modelo FdCapitulo.
    ...
    public function testActionUpdate($id)
    {
     ...
     /**
     * Deletes an existing FdCapitulo model.
