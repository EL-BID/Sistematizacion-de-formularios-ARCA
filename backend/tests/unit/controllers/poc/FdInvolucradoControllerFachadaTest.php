...
use Yii;
use backend\controllers\poc\FdInvolucradoControllerFachada;
/**
 * FdInvolucradoControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdInvolucrado.
 */
class FdInvolucradoControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdInvolucradoControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\FdInvolucradoControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\FdInvolucradoControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdInvolucradoControllerFachada' => [
                                'id_involucrado' => 'Ingresar valor de pruebas para el campo id_involucrado de tipo int4',
                             'nombre' => 'Ingresar valor de pruebas para el campo nombre de tipo varchar',
                             'telefono_convencional' => 'Ingresar valor de pruebas para el campo telefono_convencional de tipo int4',
                             'celular' => 'Ingresar valor de pruebas para el campo celular de tipo int4',
