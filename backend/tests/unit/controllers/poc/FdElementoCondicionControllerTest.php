...
use Yii;
use backend\controllers\poc\FdElementoCondicionController;


/**
 * FdElementoCondicionControllerTest implementa las acciones a través del sistema CRUD para el modelo FdElementoCondicion.
 */
class FdElementoCondicionControllerTest extends \Codeception\Test\Unit
{
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdElementoCondicionController('FdElementoCondicionController','backend\controllers\poc\FdElementoCondicionController');
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\FdElementoCondicionController', $tester);
    ...
    public function testActionIndex()
    {
        ...
        $actionIndex=Yii::$app->runAction('FdElementoCondicionController/index');
    ...
    {       
        ...
        // se deben declarar los valores de $id para enviar la llave
            ...
            $actionView=Yii::$app->runAction('FdElementoCondicionController/view',['id' => $id]);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\FdElementoCondicionController', $tester);
            ...
            $queryParams = ['FdElementoCondicionController' => [
                                             'valor' => "Ingresar valor de pruebas para el campo valor de tipo varchar",       
                                              'id_condicion' => "Ingresar valor de pruebas para el campo id_condicion de tipo int4",       
                                              'id_tcondicion' => "Ingresar valor de pruebas para el campo id_tcondicion de tipo int4",       
                                              'id_pregunta_habilitadora' => "Ingresar valor de pruebas para el campo id_pregunta_habilitadora de tipo int4",       
       ...
       //       Se declaran el post1
            ...
            $actionCreate=Yii::$app->runAction('FdElementoCondicionController/create');
    ...
    public function testActionUpdate($id)
    {
        ...
        $actionUpdate=Yii::$app->runAction('FdElementoCondicionController/update',['id' => $id]);
    ...
    public function testActionDeletep($id)
    {
        ...
        // se valida que se pueda realizar el borrado del registro
         $actionDelete=Yii::$app->runAction('FdElementoCondicionController/update',['id' => $id]);
