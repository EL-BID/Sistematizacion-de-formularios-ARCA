...
/**
 * CorMensajeEnviadoControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CorMensajeEnviado.
 */
class CorMensajeEnviadoControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CorMensajeEnviadoControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\notificaciones\CorMensajeEnviadoControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\notificaciones\CorMensajeEnviadoControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CorMensajeEnviadoControllerFachada' => [
                                'id_mensaje_enviado' => 'Ingresar valor de pruebas para el campo id_mensaje_enviado de tipo int4',
                             'cor_parametro' => 'Ingresar valor de pruebas para el campo cor_parametro de tipo text',
                             'cor_destinatario' => 'Ingresar valor de pruebas para el campo cor_destinatario de tipo text',
                             'asunto' => 'Ingresar valor de pruebas para el campo asunto de tipo varchar',
