...
/**
 * CorDestinatarioControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CorDestinatario.
 */
class CorDestinatarioControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CorDestinatarioControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\notificaciones\CorDestinatarioControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\notificaciones\CorDestinatarioControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CorDestinatarioControllerFachada' => [
                                'id_destinatario' => 'Ingresar valor de pruebas para el campo id_destinatario de tipo int4',
                             'val_defecto' => 'Ingresar valor de pruebas para el campo val_defecto de tipo varchar',
                             'consulta_sql' => 'Ingresar valor de pruebas para el campo consulta_sql de tipo text',
                             'id_correo' => 'Ingresar valor de pruebas para el campo id_correo de tipo int4',
