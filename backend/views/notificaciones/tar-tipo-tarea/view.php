...
$this->title = $model->id_ttarea;
$this->params['breadcrumbs'][] = ['label' => 'Tipo Tarea', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="tar-tipo-tarea-view">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Actualizar', ['update', 'id' => $model->id_ttarea], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Borrar', ['delete', 'id' => $model->id_ttarea], [
