...
<div class="fd-pregunta-descendiente-index">
    ...
    <p>
        ...
        ['value' =>Url::to(['poc/fd-pregunta-descendiente/create']), 'title' => 'Create Fd Pregunta Descendiente',
            ...
            [
                ...
                'buttons' => [
                    ...
                    'delete' => function($url, $model){
                            $url2 = Url::toRoute(['poc/fd-pregunta-descendiente/deletep','id_pregunta_padre' => $model->id_pregunta_padre, 'id_pregunta_descendiente' => $model->id_pregunta_descendiente, 'id_version_descendiente' => $model->id_version_descendiente, 'id_version_padre' => $model->id_version_padre],true);
