...
<div class="cda-index">
    ...
    <div class="aplicativo table-responsive">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td class="datosbasicos1"> N&uacute;mero PQRS </td>
            ...
            <tr>
                <td class="datosbasicos1"> N&uacute;mero de Quipux </td>
            ...
            <tr>
                <td colspan="4"> 
                    <table width="100%" class="actividades">
                        <tr>
                            <td>Fecha de Creaci&oacute;n</td><td>Descripci&oacute;n de la Actividad</td>
                        </tr>
                    ...
                    <table width="100%">
                        ...
                        if ($edicionactividad === true) {
                            echo '<td>'.yii\helpers\Html::button('EDITAR ACTIVIDAD',
                                    ['value' => yii\helpers\Url::toRoute(['cda/ps-cactividad-proceso/updatepqrs', 'id_cactividad_proceso' => $ultimacactividadproceso, 'id_pqrs' => $encabezado->id_pqrs, 'numero' => $encabezado->idCproceso['numero'], '_labelmiga' => 'pqrs/pqrs/index', 'registro' => '1'], true),
            ...
            <tr>
                <td colspan="4">
                    <table width="100%">
                        ...
                        <?php 
                        //=================================================acciones dinamicas ================================================//
                        foreach ($validaciones as $_clvalidaciones) {
                            if ($_clvalidaciones['dinamicaguardar'] == true) {
                                echo '<td>'.yii\helpers\Html::button($_clvalidaciones['nom_actividad'],
                                         ['value' => yii\helpers\Url::toRoute(['cda/ps-cactividad-proceso/habupdatepqrs', 'id_cproceso' => $encabezado->id_cproceso, 'id_pqrs' => $encabezado->id_pqrs, 'id_actividad_destino' => $_clvalidaciones['id_actividad_destino'], 'id_cactividad_proceso' => $ultimacactividadproceso, 'id_eproceso' => $_clvalidaciones['id_eproceso'], 'id_actividad_origen' => $_clvalidaciones['id_actividad_origen'], 'numero' => $encabezado->idCproceso['numero']], true),
                                          'class' => 'btn btn-default btn-xs showModalButton', 'title' => $_clvalidaciones['nom_actividad'],
                                         ]).'</td>';
                            }

                            //pscactividadproceso/updatedetproceso
                            if ($_clvalidaciones['dinamicaactividad'] == true) {
                                echo '<td>'.yii\helpers\Html::button($_clvalidaciones['nom_actividad'],
