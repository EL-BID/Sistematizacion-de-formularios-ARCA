        ...
        <tr>
            <td width='33%'>
                <table class='intro'>
                    <tr>
                        <td>Queja</td>
                        <td><?= $form->field($model, 'subtipo_queja')->textInput([
                                        'maxlength' => true,
                                        'title' => 'Indique con una X si su solicitud es de tipo Queja',
                                        'data-toggle' => 'tooltip',
                                        'placeholder'=>'Indique con una X'        
                            ])->label(false); ?></td>
                    </tr>
                </table>
            </td>
            <td width='33%'>
                <table class='intro'>
                    <tr>
                        <td>Reclamo</td>
                        <td><?= $form->field($model, 'subtipo_reclamo')->textInput([
                                        'maxlength' => true,
                                        'title' => 'Indique con una X si su solicitud es de tipo Reclamo',
                                        'data-toggle' => 'tooltip',
                                        'placeholder'=>'Indique con una X'        
                                         ])->label(false); ?>
            ...
            <td width='33%'>
                <table class='intro'>
                    <tr>
                        <td>Controversia</td>
                        <td><?= $form->field($model, 'subtipo_controversia')->textInput([
                                        'maxlength' => true,
                                        'title' => 'Indique con una X si su solicitd es de tipo Controversia',
                                        'data-toggle' => 'tooltip',
                                        'placeholder'=>'Indique con una X'        
                                         ])->label(false); ?>
                        </td>
