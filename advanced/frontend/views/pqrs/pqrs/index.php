...
<div class="headSection">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            ['attribute' => 'numero', 'value' => 'idCproceso.numero', 'label' => 'Número de PQRS'],
            ...
            ['attribute' => 'nombres',
                ...
                'filter' => Html::activeDropDownList($searchModel,
                            ...
                            ['class' => 'form-control', 'multiple' => false, 'prompt' => '',
                                'options' => (Yii::$app->user->identity->codRols[0]->cod_rol == 21) ? array(Yii::$app->user->identity->id_usuario => array('selected' => 'selected')) : '', ]
                            ), ],
            ...
            [
                ...
                'template' => ' {view} {estados} {excel} {pdf}',
                'buttons' => [
                     'view' => function ($url, $model) {
                        ...
                        'excel' => function ($url, $model) {
                            return Html::button("<span class='glyphicon glyphicon-list-alt' />",
                                                ['class' => 'btn btn-default btn-xs',
                                                    'onclick' => "window.location.href = '".\Yii::$app->urlManager->createUrl(['pqrs/pqrs/excel', 'id_pqrs' => $model['id_pqrs']])."';",
                                                    'data-toggle' => 'Detalle Proceso',
                                                ]
                                            );
                        },
                        ...
                        'pdf' => function ($url, $model) {
                            return Html::button("<span class='glyphicon glyphicon-file' />",
                                                ['class' => 'btn btn-default btn-xs',
                                                    'onclick' => "window.location.href = '".\Yii::$app->urlManager->createUrl(['pqrs/pqrs/pdf', 'id_pqr' => $model->id_pqrs])."';",
                                                    'data-toggle' => 'Generar PDF',
                                                ]
                                            );
                        },
