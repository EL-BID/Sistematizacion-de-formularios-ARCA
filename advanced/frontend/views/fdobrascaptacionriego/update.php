...
$this->title = 'Update Fd Obras Captacion Riego: ' . $model->id_obracaptacion;
$this->params['breadcrumbs'][] = ['label' => 'Fd Obras Captacion Riegos', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->id_obracaptacion, 'url' => ['view', 'id' => $model->id_obracaptacion]];
$this->params['breadcrumbs'][] = 'Update';
?>
<div class="fd-obras-captacion-riego-update">
