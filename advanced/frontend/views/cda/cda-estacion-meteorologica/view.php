...
$this->title = $model->id_emeteorologica;
$this->params['breadcrumbs'][] = ['label' => 'Cda Estacion Meteorologicas', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="cda-estacion-meteorologica-view">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Actualizar', ['update', 'id' => $model->id_emeteorologica], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Borrar', ['delete', 'id' => $model->id_emeteorologica], [
