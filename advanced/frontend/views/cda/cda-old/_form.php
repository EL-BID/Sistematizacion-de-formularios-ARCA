...
<div class="cda-form">
    ...
    <?php
        echo $form->field($model, 'tramite_administrativo[]')->dropDownList(
            ['Disponibilidad de Agua' => 'Disponibilidad de Agua', 'Certificado Disponibilidad de Agua' => 'Certificado Disponibilidad de Agua']
    ); 
    ?>
    ...
    <?= $form->field($model, 'numero_tramites')->textInput([
                                        'maxlength' => true,
                                        'title' => 'Indique Número Trámite',
                                        'data-toggle' => 'tooltip',
                                        'placeholder' => 'Indique Número Trámite',
                                         ]); ?>
