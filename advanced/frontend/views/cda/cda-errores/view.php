...
$this->title = $model->id_error;
$this->params['breadcrumbs'][] = ['label' => 'Cda Errores', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="cda-errores-view">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Actualizar', ['update', 'id' => $model->id_error], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Borrar', ['delete', 'id' => $model->id_error], [
