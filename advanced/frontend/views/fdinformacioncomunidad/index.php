...
/* @var $searchModel common\models\poc\FdInformacionComunidadSearch */
...
?>
<div class="fd-informacion-comunidad-index">
 ...
 <div class="aplicativo">
     <p>
        ...
        ['value' => Url::to(['fdinformacioncomunidad/createdetcapitulo',
                            'id_fmt' => $id_fmt,
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            //['attribute' => 'id_info_comunida', 'value' => 'id_info_comunida', 'label' => 'Número'],
            ['attribute' => 'cod_parroquia', 'value' => 'codParroquia.nombre_parroquia', 'label' => 'Parroquia'],
            'comunidad',
            'habitantes',
            ...
            [
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) use ($id_fmt,$id_version,$id_conj_prta,$id_cnj_rpta,$id_capitulo,$id_prta,$id_rpta,$nom_prta,$numerar,$migadepan,$estado,$capitulo,$provincia,$cantones,$parroquias,$periodos,$antvista,$focus) {
                        $urlup = Url::toRoute(['fdinformacioncomunidad/updatedetcapitulo',
                                                        'id' => $model->id_info_comunida,
                                                        'id_fmt' => $id_fmt,
                                                        'id_version' => $id_version,
                                                        'id_conj_prta' => $id_conj_prta,
                                                        'id_cnj_rpta' => $id_cnj_rpta,
                    ...
                    'delete' => function ($url, $model) use ($id_fmt,$id_version,$id_conj_prta,$id_cnj_rpta,$id_capitulo,$id_prta,$id_rpta,$nom_prta,$numerar,$migadepan,$estado,$capitulo,$provincia,$cantones,$parroquias,$periodos,$antvista,$focus) {
                        $url2 = Url::toRoute(['fdinformacioncomunidad/deletep',
                                                        'id' => $model->id_info_comunida,
                                                        'id_fmt' => $id_fmt,
                                                        'id_version' => $id_version,
                                                        'id_conj_prta' => $id_conj_prta,
