...
<div id="outer">
	...
	<div id="menu">
		...
		<ul>
             ...
             <li><a href="#2">Target.php</a></li>
             <li><a href="#3">Modelo Base de datos</a></li>
             <li><a href="#4">Ejemplo para depuración</a></li>
             <li><a href="#5">Modulo de administración</a></li>
             <li><a href="#6">Servicio Web REST</a></li>
             <li><a href="#7">Consumo del servicio</a></li>
	...
	<div id="content">
		<div id="primaryContentContainer">
			<div id="primaryContent">
				...
				<div class="well"><p>ANOTACION: Antes de iniciar se debe tener creada la base de datos ver <a href='createbd.php'>Crear BD</a></div>
				...
				<p>A continuación se explica el paso a paso para el funcionamiento del modulo de trazabilidad. </p>
					...
					<h3>Modelo de Base de Datos:</h3>
                                        ...
                                        <p>Se crea el siguiente modelo de base de datos, en la tabla aud_auditoria se agrega el campo "status" que se encarga de indicarle al trigger asignado bajo la funcion "aud_event_add()" la cual se muestra en la imagen a continuación,
                                            ...
                                            <p>Anotación: El archivo sql de las tablas relacionadas se adjunta  <a href="sql/trazabilidad.sql">aqui</a></p>
					...
					<h3>Vista Modulo Administracion:</h3>
                                        ...
                                        <blockquote>
							<?= highlight_file('../../views/logauditoria/index.php');	?>
                                        </blockquote>
                                            
                                            <p>Codigo de la vista individual de un registro "/views/logauditoria/view.php"</p> 
                                       <blockquote>
							<?= highlight_file('../../views/logauditoria/view.php');	?>
                                        </blockquote> 
							...
							<?= highlight_file('../../Controllers/LogAuditoriaController.php');	?>
                                        ...
                                        <blockquote>
							<?= highlight_file('../../models/Auditoria.php');	?>
                                        </blockquote>
                                        
                                        <p>Codigo del modelo para busquedas en la grilla "/models/AuditoriaSearch.php"</p> 
                                        <blockquote>
							<?= highlight_file('../../models/AuditoriaSearch.php');	?>
                                        </blockquote>
