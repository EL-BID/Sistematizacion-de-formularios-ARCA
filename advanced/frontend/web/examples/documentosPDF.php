...
DESTINO_STRING
                                                ...
                                                <li>Opciones:
							<p>Es un array opcional en donde se coloca la meta información para la indexación del pdf del PDF. Estas propiedades pueden ser:
				...
				<a name="2">
					<h3>Ejemplo de Uso</h3>
                                ...
                                <p> La invocación se realiza en la vista "detcapitulo/_form.php", en la declaración menu vertical</p>
                                <blockquote>
