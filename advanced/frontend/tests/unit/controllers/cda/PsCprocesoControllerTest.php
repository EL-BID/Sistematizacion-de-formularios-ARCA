...
class PsCprocesoControllerTest extends \Codeception\Test\Unit
{
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  PsCprocesoController('PsCprocesoController','frontend\controllers\cda\PsCprocesoController');
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\PsCprocesoController', $tester);
