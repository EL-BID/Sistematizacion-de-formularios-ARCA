...
/**
 * CdaErroresControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CdaErrores.
 */
class CdaErroresControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CdaErroresControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\CdaErroresControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\CdaErroresControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CdaErroresControllerFachada' => [
                                'id_error' => 'Ingresar valor de pruebas para el campo id_error de tipo int4',
                             'observaciones' => 'Ingresar valor de pruebas para el campo observaciones de tipo varchar',
                             'id_terror' => 'Ingresar valor de pruebas para el campo id_terror de tipo int4',
                             'id_cda' => 'Ingresar valor de pruebas para el campo id_cda de tipo int4',
