...
use Yii;
use frontend\controllers\cda\PsTipoSelectControllerFachada;
/**
 * PsTipoSelectControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo PsTipoSelect.
 */
class PsTipoSelectControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  PsTipoSelectControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\PsTipoSelectControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\PsTipoSelectControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['PsTipoSelectControllerFachada' => [
                                'id_tselect' => 'Ingresar valor de pruebas para el campo id_tselect de tipo int4',
                             'nom_tselect' => 'Ingresar valor de pruebas para el campo nom_tselect de tipo varchar',
                          ]];
