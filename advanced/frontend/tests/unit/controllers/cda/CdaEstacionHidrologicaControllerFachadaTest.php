...
use Yii;
use frontend\controllers\cda\CdaEstacionHidrologicaControllerFachada;
/**
 * CdaEstacionHidrologicaControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CdaEstacionHidrologica.
 */
class CdaEstacionHidrologicaControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CdaEstacionHidrologicaControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\CdaEstacionHidrologicaControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\CdaEstacionHidrologicaControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CdaEstacionHidrologicaControllerFachada' => [
                                'id_ehidrografica' => 'Ingresar valor de pruebas para el campo id_ehidrografica de tipo varchar',
                             'nom_ehidrografica' => 'Ingresar valor de pruebas para el campo nom_ehidrografica de tipo varchar',
                          ]];
