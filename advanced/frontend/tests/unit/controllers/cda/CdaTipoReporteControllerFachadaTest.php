...
use Yii;
use frontend\controllers\cda\CdaTipoReporteControllerFachada;
/**
 * CdaTipoReporteControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CdaTipoReporte.
 */
class CdaTipoReporteControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CdaTipoReporteControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\CdaTipoReporteControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\CdaTipoReporteControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CdaTipoReporteControllerFachada' => [
                                'id_treporte' => 'Ingresar valor de pruebas para el campo id_treporte de tipo int4',
                             'nom_treporte' => 'Ingresar valor de pruebas para el campo nom_treporte de tipo varchar',
                          ]];
