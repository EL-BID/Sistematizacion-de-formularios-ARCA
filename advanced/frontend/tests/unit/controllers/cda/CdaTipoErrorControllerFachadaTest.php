...
/**
 * CdaTipoErrorControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CdaTipoError.
 */
class CdaTipoErrorControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CdaTipoErrorControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\CdaTipoErrorControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\CdaTipoErrorControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CdaTipoErrorControllerFachada' => [
                                'id_terror' => 'Ingresar valor de pruebas para el campo id_terror de tipo int4',
                             'nom_terror' => 'Ingresar valor de pruebas para el campo nom_terror de tipo varchar',
                          ]];
