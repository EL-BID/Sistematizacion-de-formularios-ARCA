...
use Yii;
use frontend\controllers\cda\CdaSubtipoFuenteControllerFachada;
/**
 * CdaSubtipoFuenteControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CdaSubtipoFuente.
 */
class CdaSubtipoFuenteControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CdaSubtipoFuenteControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\CdaSubtipoFuenteControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\CdaSubtipoFuenteControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CdaSubtipoFuenteControllerFachada' => [
                                'id_subtfuente' => 'Ingresar valor de pruebas para el campo id_subtfuente de tipo int4',
                             'nom_subtfuente' => 'Ingresar valor de pruebas para el campo nom_subtfuente de tipo varchar',
                          ]];
