...
use Yii;
use frontend\controllers\cda\PsTipoActividadControllerFachada;
/**
 * PsTipoActividadControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo PsTipoActividad.
 */
class PsTipoActividadControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  PsTipoActividadControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\PsTipoActividadControllerFachada', $tester);
    ...
    /**
     * Presenta un dato unico en el modelo PsTipoActividad.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Crea un nuevo dato sobre el modelo PsTipoActividad .
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\PsTipoActividadControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['PsTipoActividadControllerFachada' => [
                                'id_tactividad' => 'Ingresar valor de pruebas para el campo id_tactividad de tipo int4',
                             'nom_tactividad' => 'Ingresar valor de pruebas para el campo nom_tactividad de tipo varchar',
                          ]];
     ...
     /**
     * Modifica un dato existente en el modelo PsTipoActividad.
    ...
    public function testActionUpdate($id)
    {
     ...
     /**
     * Deletes an existing PsTipoActividad model.
