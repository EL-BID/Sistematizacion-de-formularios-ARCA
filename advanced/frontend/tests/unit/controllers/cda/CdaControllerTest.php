...
use Yii;
use frontend\controllers\cda\CdaController;
...
class CdaControllerTest extends \Codeception\Test\Unit
{
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CdaController('CdaController','frontend\controllers\cda\CdaController');
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\CdaController', $tester);
