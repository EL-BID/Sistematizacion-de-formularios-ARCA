...
use Yii;
use frontend\controllers\cda\PsProcesoControllerFachada;
/**
 * PsProcesoControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo PsProceso.
 */
class PsProcesoControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  PsProcesoControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\PsProcesoControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\PsProcesoControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['PsProcesoControllerFachada' => [
                                'id_proceso' => 'Ingresar valor de pruebas para el campo id_proceso de tipo int4',
                             'nom_proceso' => 'Ingresar valor de pruebas para el campo nom_proceso de tipo varchar',
                             'id_tproceso' => 'Ingresar valor de pruebas para el campo id_tproceso de tipo int4',
                             'id_modulo' => 'Ingresar valor de pruebas para el campo id_modulo de tipo int4',
