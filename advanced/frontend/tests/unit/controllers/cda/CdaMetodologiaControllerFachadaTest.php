...
use Yii;
use frontend\controllers\cda\CdaMetodologiaControllerFachada;
/**
 * CdaMetodologiaControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CdaMetodologia.
 */
class CdaMetodologiaControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CdaMetodologiaControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\CdaMetodologiaControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\CdaMetodologiaControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CdaMetodologiaControllerFachada' => [
                                'id_metodologia' => 'Ingresar valor de pruebas para el campo id_metodologia de tipo int4',
                             'nom_metodologia' => 'Ingresar valor de pruebas para el campo nom_metodologia de tipo varchar',
                          ]];
