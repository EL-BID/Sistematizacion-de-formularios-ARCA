...
use Yii;
use frontend\controllers\cda\PsTipoProcesoControllerFachada;
/**
 * PsTipoProcesoControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo PsTipoProceso.
 */
class PsTipoProcesoControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  PsTipoProcesoControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\PsTipoProcesoControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\PsTipoProcesoControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['PsTipoProcesoControllerFachada' => [
                                'id_tproceso' => 'Ingresar valor de pruebas para el campo id_tproceso de tipo int4',
                             'nom_tproceso' => 'Ingresar valor de pruebas para el campo nom_tproceso de tipo varchar',
                          ]];
