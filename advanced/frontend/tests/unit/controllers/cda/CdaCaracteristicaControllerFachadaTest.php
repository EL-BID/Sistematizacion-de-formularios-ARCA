...
use Yii;
use frontend\controllers\cda\CdaCaracteristicaControllerFachada;
/**
 * CdaCaracteristicaControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CdaCaracteristica.
 */
class CdaCaracteristicaControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CdaCaracteristicaControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\CdaCaracteristicaControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\CdaCaracteristicaControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CdaCaracteristicaControllerFachada' => [
                                'id_caracteristica' => 'Ingresar valor de pruebas para el campo id_caracteristica de tipo int4',
                             'nom_caracteristica' => 'Ingresar valor de pruebas para el campo nom_caracteristica de tipo varchar',
                          ]];
