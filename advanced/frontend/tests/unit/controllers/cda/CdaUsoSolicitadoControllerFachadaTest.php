...
use Yii;
use frontend\controllers\cda\CdaUsoSolicitadoControllerFachada;
/**
 * CdaUsoSolicitadoControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CdaUsoSolicitado.
 */
class CdaUsoSolicitadoControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CdaUsoSolicitadoControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\CdaUsoSolicitadoControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\CdaUsoSolicitadoControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CdaUsoSolicitadoControllerFachada' => [
                                'id_uso_solicitado' => 'Ingresar valor de pruebas para el campo id_uso_solicitado de tipo int4',
                             'nom_uso_solicitado' => 'Ingresar valor de pruebas para el campo nom_uso_solicitado de tipo varchar',
                          ]];
