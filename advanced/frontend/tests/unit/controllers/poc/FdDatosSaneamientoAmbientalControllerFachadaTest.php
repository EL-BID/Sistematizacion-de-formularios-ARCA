...
/**
 * FdDatosSaneamientoAmbientalControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdDatosSaneamientoAmbiental.
 */
class FdDatosSaneamientoAmbientalControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdDatosSaneamientoAmbientalControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\poc\FdDatosSaneamientoAmbientalControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\poc\FdDatosSaneamientoAmbientalControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdDatosSaneamientoAmbientalControllerFachada' => [
                                'id_datos_saneamiento_ambiental' => 'Ingresar valor de pruebas para el campo id_datos_saneamiento_ambiental de tipo int4',
                             'comunidad' => 'Ingresar valor de pruebas para el campo comunidad de tipo varchar',
                             'viviendas_existentes' => 'Ingresar valor de pruebas para el campo viviendas_existentes de tipo int4',
                             'viviendas_conexiones' => 'Ingresar valor de pruebas para el campo viviendas_conexiones de tipo int4',
