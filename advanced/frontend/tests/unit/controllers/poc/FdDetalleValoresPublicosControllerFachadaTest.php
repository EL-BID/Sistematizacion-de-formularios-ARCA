...
/**
 * FdDetalleValoresPublicosControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdDetalleValoresPublicos.
 */
class FdDetalleValoresPublicosControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdDetalleValoresPublicosControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\poc\FdDetalleValoresPublicosControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\poc\FdDetalleValoresPublicosControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdDetalleValoresPublicosControllerFachada' => [
                                'id_detalle_valores_publicos' => 'Ingresar valor de pruebas para el campo id_detalle_valores_publicos de tipo int4',
                             'codigo' => 'Ingresar valor de pruebas para el campo codigo de tipo int4',
                             'descripcion' => 'Ingresar valor de pruebas para el campo descripcion de tipo varchar',
                             'enero' => 'Ingresar valor de pruebas para el campo enero de tipo numeric',
