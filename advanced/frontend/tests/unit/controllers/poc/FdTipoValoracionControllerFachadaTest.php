...
use Yii;
use frontend\controllers\poc\FdTipoValoracionControllerFachada;
/**
 * FdTipoValoracionControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdTipoValoracion.
 */
class FdTipoValoracionControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdTipoValoracionControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\poc\FdTipoValoracionControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\poc\FdTipoValoracionControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdTipoValoracionControllerFachada' => [
                                'id_tipo_valoracion' => 'Ingresar valor de pruebas para el campo id_tipo_valoracion de tipo int4',
                             'descripcion_valoracion' => 'Ingresar valor de pruebas para el campo descripcion_valoracion de tipo varchar',
                          ]];
