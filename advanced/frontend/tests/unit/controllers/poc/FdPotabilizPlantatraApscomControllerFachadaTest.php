...
/**
 * FdPotabilizPlantatraApscomControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdPotabilizPlantatraApscom.
 */
class FdPotabilizPlantatraApscomControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdPotabilizPlantatraApscomControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\poc\FdPotabilizPlantatraApscomControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\poc\FdPotabilizPlantatraApscomControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdPotabilizPlantatraApscomControllerFachada' => [
                                'id_potab_plantatr_apscom' => 'Ingresar valor de pruebas para el campo id_potab_plantatr_apscom de tipo int4',
                             'ubicacion_lug_ptratamiento' => 'Ingresar valor de pruebas para el campo ubicacion_lug_ptratamiento de tipo varchar',
                             'tipo_planta_tratatmiento' => 'Ingresar valor de pruebas para el campo tipo_planta_tratatmiento de tipo int4',
                             'especifique_tplantat' => 'Ingresar valor de pruebas para el campo especifique_tplantat de tipo varchar',
