...
/**
 * InformacionprestadoresControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo Informacionprestadores.
 */
class InformacionprestadoresControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  InformacionprestadoresControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\poc\InformacionprestadoresControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\poc\InformacionprestadoresControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['InformacionprestadoresControllerFachada' => [
                                'id_informacion_prestadores' => 'Ingresar valor de pruebas para el campo id_informacion_prestadores de tipo numeric',
                             'posee_prestadores' => 'Ingresar valor de pruebas para el campo posee_prestadores de tipo varchar',
                             'numero_prestadores' => 'Ingresar valor de pruebas para el campo numero_prestadores de tipo int4',
                             'numero_prestadores_legal' => 'Ingresar valor de pruebas para el campo numero_prestadores_legal de tipo int4',
