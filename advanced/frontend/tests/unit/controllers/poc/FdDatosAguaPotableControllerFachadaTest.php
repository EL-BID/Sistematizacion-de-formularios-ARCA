...
use Yii;
use frontend\controllers\poc\FdDatosAguaPotableControllerFachada;
/**
 * FdDatosAguaPotableControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdDatosAguaPotable.
 */
class FdDatosAguaPotableControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdDatosAguaPotableControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\poc\FdDatosAguaPotableControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\poc\FdDatosAguaPotableControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdDatosAguaPotableControllerFachada' => [
                                'id_datos_agua_potable' => 'Ingresar valor de pruebas para el campo id_datos_agua_potable de tipo int4',
                             'comunidad' => 'Ingresar valor de pruebas para el campo comunidad de tipo varchar',
                             'viviendas_existentes' => 'Ingresar valor de pruebas para el campo viviendas_existentes de tipo int4',
                             'viviendas_agua_potable' => 'Ingresar valor de pruebas para el campo viviendas_agua_potable de tipo int4',
