...
use Yii;
use frontend\controllers\cargaquipux\PsCargueControllerFachada;
/**
 * PsCargueControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo PsCargue.
 */
class PsCargueControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  PsCargueControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cargaquipux\PsCargueControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cargaquipux\PsCargueControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['PsCargueControllerFachada' => [
                                'id_cargues' => 'Ingresar valor de pruebas para el campo id_cargues de tipo int4',
                             'ruta' => 'Ingresar valor de pruebas para el campo ruta de tipo varchar',
                             'procesado' => 'Ingresar valor de pruebas para el campo procesado de tipo varchar',
                             'fecha_cargue' => 'Ingresar valor de pruebas para el campo fecha_cargue de tipo date',
