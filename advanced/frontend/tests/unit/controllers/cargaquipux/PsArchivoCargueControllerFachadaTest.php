...
use Yii;
use frontend\controllers\cargaquipux\PsArchivoCargueControllerFachada;
/**
 * PsArchivoCargueControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo PsArchivoCargue.
 */
class PsArchivoCargueControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  PsArchivoCargueControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cargaquipux\PsArchivoCargueControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cargaquipux\PsArchivoCargueControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['PsArchivoCargueControllerFachada' => [
                                'id_archivo_cargue' => 'Ingresar valor de pruebas para el campo id_archivo_cargue de tipo int4',
                             'nom_archivo_cargue' => 'Ingresar valor de pruebas para el campo nom_archivo_cargue de tipo varchar',
                             'nom_tabla_cargue' => 'Ingresar valor de pruebas para el campo nom_tabla_cargue de tipo varchar',
                             'fila_inicio' => 'Ingresar valor de pruebas para el campo fila_inicio de tipo int4',
