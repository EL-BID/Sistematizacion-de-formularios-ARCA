...
class DashboardController extends Controller
{
    ...
    public function actionIndex($id_conj_rpta,$id_conj_prta,$id_fmt,$last,$estado)
    {
       ...
       if(empty($_dil_DatosGenerales->id_datos_generales)){
           $_dil_DatosGenerales='';
       }
       ...
       if($_HTMLdashboard[0] === FALSE){
            ...
            throw new \yii\web\HttpException(404, 'No tiene permisos para visualizar el dashboard');
            
       }else{
           
           return $this->render('index', [
            '_stringhtml' => $_HTMLdashboard[0],
            ]);
