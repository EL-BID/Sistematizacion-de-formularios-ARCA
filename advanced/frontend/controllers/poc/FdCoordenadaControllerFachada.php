...
use common\models\poc\FdCoordenadaSearch;
 ...
 */
class FdCoordenadaControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    {
                $searchModel = new FdCoordenadaSearch();
    ...
    /**
     * Finds the FdCoordenada model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return FdCoordenada the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
                    if (($model = FdCoordenada::findOne($id)) !== null) {
                        return $model;
                    } else {
     ...
     * 
     * @param type $params
     * @return type CorCorreo
     */
    protected function findModelByParams($params)
    {
            if (($model = FdCoordenada::findOne($params)) !== null) {
                return $model;
            }
                else{
     ...
     * @return type CorCorreo
     */
     public function cargaCoordenada($params){
