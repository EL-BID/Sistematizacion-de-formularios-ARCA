...
use Yii;
use frontend\controllers\poc\FdTrataguaDesinfeccionApscomControllerFachada;
...
/**
 * FdTrataguaDesinfeccionApscomController implementa las acciones a través del sistema CRUD para el modelo FdTrataguaDesinfeccionApscom.
 */
class FdTrataguaDesinfeccionApscomController extends ControllerPry
{
  //private $facade =    FdTrataguaDesinfeccionApscomControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdTrataguaDesinfeccionApscomControllerFachada;
    ...
    public function actionIndexdetcapitulo($id_fmt, $id_version, $id_conj_prta, $id_cnj_rpta, $id_capitulo, $id_prta, $id_rpta, $numerar, $nom_prta, $migadepan, $estado, $capitulo, $provincia, $cantones, $parroquias, $periodos, $antvista, $focus,$idjunta)
    {
        ...
        if (empty($id_rpta)) {
            ...
            $rpta_exists = FdRespuesta::find()
                          ...
                          ->andwhere(['=', 'fd_respuesta.id_tpregunta', '32'])
        ...
        $facade = new FdTrataguaDesinfeccionApscomControllerFachada();//FdConduccionImpulsionApscomControllerFachada();
        //FdInvolucradoSearch
        $_busquedap = ['FdTrataguaDesinfeccionApscomSearch' => [
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_trat_aguadesinf_apscom]);		
