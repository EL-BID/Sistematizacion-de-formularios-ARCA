...
use common\models\poc\FdParamEvaluacionesSearch;
...
/**
 * FdParamEvaluacionesControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdParamEvaluaciones.
 */
class FdParamEvaluacionesControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    {
                $searchModel = new FdParamEvaluacionesSearch();
    ...
    /**
     * Encuentra el modelo de FdParamEvaluaciones basado en el valor de la primary key.
     * Si no encuentra respuesta, arroja una excepcion 404 HTTP.
     * @param integer $id
     * @return FdParamEvaluaciones el modelo cargado
     * @throws NotFoundHttpException si no puede ser encontrada la respuesta
     */
    protected function findModel($id)
    {
                    if (($model = FdParamEvaluaciones::findOne($id)) !== null) {
                        return $model;
                    } else {
     ...
     * @return type  FdParamEvaluaciones     */
    protected function findModelByParams($params)
    {
        if (($model = FdParamEvaluaciones::findAll($params)) !== null) {
            return $model;
        }
        else{
            return null;
    ...
    /**
     * Funcion visible para los objetos que necesiten una consulta al modelo FdParamEvaluaciones     
     * @param type $params contiene array con valores de query a columnas de la tabla
     * @return type FdParamEvaluaciones     */
     public function cargaFdParamEvaluaciones($params){
