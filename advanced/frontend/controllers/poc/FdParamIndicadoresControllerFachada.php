...
use common\models\poc\FdParamIndicadoresSearch;
...
/**
 * FdParamIndicadoresControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdParamIndicadores.
 */
class FdParamIndicadoresControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    {
                $searchModel = new FdParamIndicadoresSearch();
    ...
    /**
     * Encuentra el modelo de FdParamIndicadores basado en el valor de la primary key.
     * Si no encuentra respuesta, arroja una excepcion 404 HTTP.
     * @param integer $id
     * @return FdParamIndicadores el modelo cargado
     * @throws NotFoundHttpException si no puede ser encontrada la respuesta
     */
    protected function findModel($id)
    {
                    if (($model = FdParamIndicadores::findOne($id)) !== null) {
                        return $model;
                    } else {
     ...
     * @return type  FdParamIndicadores     */
    protected function findModelByParams($params)
    {
        if (($model = FdParamIndicadores::findAll($params)) !== null) {
            return $model;
        }
        else{
            return null;
    ...
    /**
     * Funcion visible para los objetos que necesiten una consulta al modelo FdParamIndicadores     
     * @param type $params contiene array con valores de query a columnas de la tabla
     * @return type FdParamIndicadores     */
     public function cargaFdParamIndicadores($params){
