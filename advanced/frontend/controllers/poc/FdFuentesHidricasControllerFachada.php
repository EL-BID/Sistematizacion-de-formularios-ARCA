...
use common\models\poc\FdFuentesHidricasSearch;
...
/**
 * FdFuentesHidricasControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdFuentesHidricas.
 */
class FdFuentesHidricasControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
...
public function actionProgress($urlroute,$id_fmt,$id_version,$id_conj_prta,$id_cnj_rpta,$id_capitulo,$id_prta,$id_rpta,$nom_prta,$numerar,$migadepan,$estado,$capitulo,$provincia,$cantones,$parroquias,$periodos,$antvista,$focus){
    ...
    {                
                $searchModel = new FdFuentesHidricasSearch();
    ...
    /**
     * Deletes an existing FdFuentesHidricas model.
    ...
    /**
     * Encuentra el modelo de FdFuentesHidricas basado en el valor de la primary key.
     * Si no encuentra respuesta, arroja una excepcion 404 HTTP.
     * @param integer $id
     * @return FdFuentesHidricas el modelo cargado
     * @throws NotFoundHttpException si no puede ser encontrada la respuesta
     */
    protected function findModel($id)
    {
                    if (($model = FdFuentesHidricas::findOne($id)) !== null) {
                        return $model;
                    } else {
     ...
     * @return type  FdFuentesHidricas     */
    protected function findModelByParams($params)
    {
        if (($model = FdFuentesHidricas::findAll($params)) !== null) {
            return $model;
        }
        else{
            return null;
    ...
    /**
     * Funcion visible para los objetos que necesiten una consulta al modelo FdFuentesHidricas     
     * @param type $params contiene array con valores de query a columnas de la tabla
     * @return type FdFuentesHidricas     */
     public function cargaFdFuentesHidricas($params){
