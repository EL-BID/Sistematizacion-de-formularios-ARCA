...
use common\models\poc\FdPotabilizPlantatraApscomSearch;
...
/**
 * FdPotabilizPlantatraApscomControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdPotabilizPlantatraApscom.
 */
class FdPotabilizPlantatraApscomControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    {
                $searchModel = new FdPotabilizPlantatraApscomSearch();
    ...
    {
        $model = new FdPotabilizPlantatraApscom();
    ...
    /**
     * Encuentra el modelo de FdPotabilizPlantatraApscom basado en el valor de la primary key.
     * Si no encuentra respuesta, arroja una excepcion 404 HTTP.
     * @param integer $id
     * @return FdPotabilizPlantatraApscom el modelo cargado
     * @throws NotFoundHttpException si no puede ser encontrada la respuesta
     */
    protected function findModel($id)
    {
                    if (($model = FdPotabilizPlantatraApscom::findOne($id)) !== null) {
                        return $model;
                    } else {
     ...
     * @return type  FdPotabilizPlantatraApscom     */
    protected function findModelByParams($params)
    {
        if (($model = FdPotabilizPlantatraApscom::findAll($params)) !== null) {
            return $model;
        }
        else{
            return null;
    ...
    /**
     * Funcion visible para los objetos que necesiten una consulta al modelo FdPotabilizPlantatraApscom     
     * @param type $params contiene array con valores de query a columnas de la tabla
     * @return type FdPotabilizPlantatraApscom     */
     public function cargaFdPotabilizPlantatraApscom($params){
