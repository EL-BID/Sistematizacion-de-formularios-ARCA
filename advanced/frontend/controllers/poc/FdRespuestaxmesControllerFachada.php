...
use common\models\poc\FdRespuestaXMesSearch;
...
/**
 * FdRespuestaXMesControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdRespuestaXMes.
 */
class FdRespuestaxmesControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    {
                $searchModel = new FdRespuestaXMesSearch();
     ...
     * @return mixed
     */
    public function actionCreate($request,$isAjax,$id_prta,$id_rpta)
    {
        $model = new FdRespuestaxmes();
    ...
    /**
     * Finds the FdRespuestaXMes model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return FdRespuestaXMes the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
                    if (($model = FdRespuestaXMes::findOne($id)) !== null) {
                        return $model;
                    } else {
