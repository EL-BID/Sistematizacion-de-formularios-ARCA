...
use Yii;
use frontend\controllers\poc\FdDetalleValoresPublicosControllerFachada;
...
/**
 * FdDetalleValoresPublicosController implementa las acciones a través del sistema CRUD para el modelo FdDetalleValoresPublicos.
 */
class FdDetalleValoresPublicosController extends ControllerPry
{
  //private $facade =    FdDetalleValoresPublicosControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdDetalleValoresPublicosControllerFachada;
    ...
    {                
        ...
        if (empty($id_rpta)) {
            ...
            $rpta_exists = FdRespuesta::find()
                          ...
                          ->andwhere(['=', 'fd_respuesta.id_tpregunta', '28'])
        ...
        $facade = new FdDetalleValoresPublicosControllerFachada();
        //FdInvolucradoSearch
        $_busquedap = ['FdDetalleValoresPublicosSearch' => [
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_detalle_valores_publicos]);		
 ...
 /**
     * Modifica un dato existente en el modelo FdDetalleValoresPublicos asociadas a un formato
     * Si se modifica correctamente guarda setFlash, presenta la barra de progreso y envia a view con la confirmación de guardado..
     *
     * @param int $id
     *
     * @return mixed
     */
    public function actionUpdatedetcapitulo($id,$id2, $id_fmt, $id_version, $id_conj_prta, $id_cnj_rpta, $id_capitulo, $id_prta, $id_rpta, $nom_prta, $numerar, $migadepan, $estado, $capitulo, $provincia, $cantones, $parroquias, $periodos, $antvista, $focus,$fuentes)
    {
        //Averiguando Permisos
        if (empty(Yii::$app->user->identity->usuario)) {
            return $this->redirect(['site/index']);
        ...
        $facade = new FdDetalleValoresPublicosControllerFachada();
        $modelE = $facade->actionUpdate($id,$id2, Yii::$app->request->post(), Yii::$app->request->isAjax);
        $model = $modelE['model'];
	...
	if ($modelE['update'] == 'True') {
            ...
            //para esta pantalla se requiere que se redireccione al mismo index
            $redireccionar_a = 'indexdetcapitulo';
