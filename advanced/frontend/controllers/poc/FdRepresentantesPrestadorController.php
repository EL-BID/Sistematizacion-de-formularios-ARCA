...
use Yii;
use frontend\controllers\poc\FdRepresentantesPrestadorControllerFachada;
...
/**
 * FdRepresentantesPrestadorController implementa las acciones a través del sistema CRUD para el modelo FdRepresentantesPrestador.
 */
class FdRepresentantesPrestadorController extends ControllerPry
{
    ...
    {
        $facade =  new  FdRepresentantesPrestadorControllerFachada;
...
/*-*-*-*-*-*-*-*-*-* INICIO DEL CODIGO PARA PANTALLA N REGISTROS *-*-*-*-*-*-*-*-*-*-*-*-*-*/    
    ...
    public function actionIndexdetcapitulo($id_fmt, $id_version, $id_conj_prta, $id_cnj_rpta, $id_capitulo, $id_prta, $id_rpta, $numerar, $nom_prta, $migadepan, $estado, $capitulo, $provincia, $cantones, $parroquias, $periodos, $antvista, $focus)
    {
        ...
        $facade = new FdRepresentantesPrestadorControllerFachada();
        //FdInvolucradoSearch
        $_busquedap = ['FdRepresentantesPrestadorSearch' => [
   ...
   /**
    ...
    public function actionUpdate($id)
    {
        ...
        if ($modelE['update'] == 'True') {
            ...
            return $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_representantes_prestador]);
