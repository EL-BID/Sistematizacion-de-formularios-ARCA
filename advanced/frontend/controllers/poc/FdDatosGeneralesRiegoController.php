...
/**
 * FdDatosGeneralesRiegoController implementa las acciones a través del sistema CRUD para el modelo FdDatosGeneralesRiego.
 */
class FdDatosGeneralesRiegoController extends ControllerPry
{
  //private $facade =    FdDatosGeneralesRiegoControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdDatosGeneralesRiegoControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_datos_generales_riego]);		
