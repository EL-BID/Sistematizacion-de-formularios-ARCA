...
use common\models\poc\FdInformacionComunidadSearch;
...
/**
 * FdInformacionComunidadControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdInformacionComunidad.
 */
class FdInformacionComunidadControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    {
                $searchModel = new FdInformacionComunidadSearch();
    ...
    {
        $model = new FdInformacionComunidad();
 if(!empty($id_cnj_rpta)){
    ...
    /**
     * Encuentra el modelo de FdInformacionComunidad basado en el valor de la primary key.
     * Si no encuentra respuesta, arroja una excepcion 404 HTTP.
     * @param integer $id
     * @return FdInformacionComunidad el modelo cargado
     * @throws NotFoundHttpException si no puede ser encontrada la respuesta
     */
    protected function findModel($id)
    {
                    if (($model = FdInformacionComunidad::findOne($id)) !== null) {
                        return $model;
                    } else {
     ...
     * @return type  FdInformacionComunidad     */
    protected function findModelByParams($params)
    {
        if (($model = FdInformacionComunidad::findAll($params)) !== null) {
            return $model;
        }
        else{
            return null;
    ...
    /**
     * Funcion visible para los objetos que necesiten una consulta al modelo FdInformacionComunidad     
     * @param type $params contiene array con valores de query a columnas de la tabla
     * @return type FdInformacionComunidad     */
     public function cargaFdInformacionComunidad($params){
