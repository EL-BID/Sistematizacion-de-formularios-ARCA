...
use Yii;
use frontend\controllers\poc\FdConduccionGravedadApControllerFachada;
...
/**
 * FdConduccionGravedadApController implementa las acciones a través del sistema CRUD para el modelo FdConduccionGravedadAp.
 */
class FdConduccionGravedadApController extends ControllerPry
{
  //private $facade =    FdConduccionGravedadApControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade = new  FdConduccionGravedadApControllerFachada();
    ...
    public function actionIndexdetcapitulo($id_fmt, $id_version, $id_conj_prta, $id_cnj_rpta, $id_capitulo, $id_prta, $id_rpta, $numerar, $nom_prta, $migadepan, $estado, $capitulo, $provincia, $cantones, $parroquias, $periodos, $antvista, $focus, $idjunta)
    {
        ...
        if (empty($id_rpta)) {
            ...
            $rpta_exists = FdRespuesta::find()
                          ...
                          ->andwhere(['=', 'fd_respuesta.id_tpregunta', '36'])
        ...
        $facade = new FdConduccionGravedadApControllerFachada();
        //FdInvolucradoSearch
        $_busquedap = ['FdConduccionGravedadApSearch' => [
    ...
    public function actionCreatedetcapitulo($id_fmt, $id_version, $id_conj_prta, $id_cnj_rpta, $id_capitulo, $id_prta, $id_rpta, $nom_prta, $numerar, $migadepan, $estado, $capitulo, $provincia, $cantones, $parroquias, $periodos, $antvista, $focus, $idjunta)
    {
        ...
        //$facade =  new FdInvolucradoControllerFachada();
        $facade = new  FdConduccionGravedadApControllerFachada();
        $modelE = $facade->actionCreate(Yii::$app->request->post(), Yii::$app->request->isAjax, $id_cnj_rpta, $id_prta, $id_rpta, $focus, $idjunta);
        $model = $modelE['model'];
