...
use Yii;
use frontend\controllers\poc\FdDatosSaneamientoAmbientalControllerFachada;
...
/**
 * FdDatosSaneamientoAmbientalController implementa las acciones a través del sistema CRUD para el modelo FdDatosSaneamientoAmbiental.
 */
class FdDatosSaneamientoAmbientalController extends ControllerPry
{
  //private $facade =    FdDatosSaneamientoAmbientalControllerFachada;
    /**
     * {@inheritdoc}
     */
    public function behaviors()
    {
        $facade =  new  FdDatosSaneamientoAmbientalControllerFachada;
...
/*-*-*-*-*-*-*-*-*-* INICIO DEL CODIGO PARA PANTALLA N REGISTROS *-*-*-*-*-*-*-*-*-*-*-*-*-*/    
    ...
    public function actionIndexdetcapitulo($id_fmt, $id_version, $id_conj_prta, $id_cnj_rpta, $id_capitulo, $id_prta, $id_rpta, $numerar, $nom_prta, $migadepan, $estado, $capitulo, $provincia, $cantones, $parroquias, $periodos, $antvista, $focus)
    {
        ...
        $facade = new FdDatosSaneamientoAmbientalControllerFachada();
        //FdInvolucradoSearch
        $_busquedap = ['FdDatosSaneamientoAmbientalSearch' => [
...
/*-*-*-*-*-*-*-*-*-* FIN DEL CODIGO PARA PANTALLA N REGISTROS *-*-*-*-*-*-*-*-*-*-*-*-*-*/    
   ...
   /**
    ...
    /*-*-*-*-*-*-*-*-*-* FIN 2 DEL CODIGO PARA PANTALLA N REGISTROS *-*-*-*-*-*-*-*-*-*-*-*-*-*/
    ...
    public function actionUpdate($id)
    {
        ...
        if ($modelE['update'] == 'True') {
            ...
            return $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_datos_saneamiento_ambiental]);
