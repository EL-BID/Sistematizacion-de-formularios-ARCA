...
use common\models\poc\FdCaudalAguaPublicosSearch;
...
/**
 * FdCaudalAguaPublicosControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdCaudalAguaPublicos.
 */
class FdCaudalAguaPublicosControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    {
                $searchModel = new FdCaudalAguaPublicosSearch();
    ...
    {
        $model = new FdCaudalAguaPublicos();
    ...
    /**
     * Encuentra el modelo de FdCaudalAguaPublicos basado en el valor de la primary key.
     * Si no encuentra respuesta, arroja una excepcion 404 HTTP.
     * @param integer $id
     * @return FdCaudalAguaPublicos el modelo cargado
     * @throws NotFoundHttpException si no puede ser encontrada la respuesta
     */
    protected function findModel($id)
    {
                    if (($model = FdCaudalAguaPublicos::findOne($id)) !== null) {
                        return $model;
                    } else {
     ...
     * @return type  FdCaudalAguaPublicos     */
    protected function findModelByParams($params)
    {
        if (($model = FdCaudalAguaPublicos::findAll($params)) !== null) {
            return $model;
        }
        else{
            return null;
    ...
    /**
     * Funcion visible para los objetos que necesiten una consulta al modelo FdCaudalAguaPublicos     
     * @param type $params contiene array con valores de query a columnas de la tabla
     * @return type FdCaudalAguaPublicos     */
     public function cargaFdCaudalAguaPublicos($params){
