...
use common\models\poc\FdTanquesAlmacenaApscomSearch;
...
/**
 * FdTanquesAlmacenaApscomControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdTanquesAlmacenaApscom.
 */
class FdTanquesAlmacenaApscomControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    {
                $searchModel = new FdTanquesAlmacenaApscomSearch();
    ...
    {
        $model = new FdTanquesAlmacenaApscom();
    ...
    /**
     * Encuentra el modelo de FdTanquesAlmacenaApscom basado en el valor de la primary key.
     * Si no encuentra respuesta, arroja una excepcion 404 HTTP.
     * @param integer $id
     * @return FdTanquesAlmacenaApscom el modelo cargado
     * @throws NotFoundHttpException si no puede ser encontrada la respuesta
     */
    protected function findModel($id)
    {
                    if (($model = FdTanquesAlmacenaApscom::findOne($id)) !== null) {
                        return $model;
                    } else {
     ...
     * @return type  FdTanquesAlmacenaApscom     */
    protected function findModelByParams($params)
    {
        if (($model = FdTanquesAlmacenaApscom::findAll($params)) !== null) {
            return $model;
        }
        else{
            return null;
    ...
    /**
     * Funcion visible para los objetos que necesiten una consulta al modelo FdTanquesAlmacenaApscom     
     * @param type $params contiene array con valores de query a columnas de la tabla
     * @return type FdTanquesAlmacenaApscom     */
     public function cargaFdTanquesAlmacenaApscom($params){
