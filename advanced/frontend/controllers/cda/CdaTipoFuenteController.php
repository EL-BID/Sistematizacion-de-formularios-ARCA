...
/**
 * CdaTipoFuenteController implementa las acciones a través del sistema CRUD para el modelo CdaTipoFuente.
 */
class CdaTipoFuenteController extends ControllerPry
{
  //private $facade =    CdaTipoFuenteControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  CdaTipoFuenteControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_tfuente]);		
