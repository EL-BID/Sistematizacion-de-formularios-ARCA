...
/**
 * PsEstadoProcesoController implementa las acciones a través del sistema CRUD para el modelo PsEstadoProceso.
 */
class PsEstadoProcesoController extends ControllerPry
{
  //private $facade =    PsEstadoProcesoControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  PsEstadoProcesoControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_eproceso]);		
