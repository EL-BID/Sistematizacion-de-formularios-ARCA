...
/**
 * CdaEstacionHidrologicaController implementa las acciones a través del sistema CRUD para el modelo CdaEstacionHidrologica.
 */
class CdaEstacionHidrologicaController extends ControllerPry
{
  //private $facade =    CdaEstacionHidrologicaControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  CdaEstacionHidrologicaControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_ehidrografica]);		
