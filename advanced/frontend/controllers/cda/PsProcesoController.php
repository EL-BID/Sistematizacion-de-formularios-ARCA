...
/**
 * PsProcesoController implementa las acciones a través del sistema CRUD para el modelo PsProceso.
 */
class PsProcesoController extends ControllerPry
{
  //private $facade =    PsProcesoControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  PsProcesoControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_proceso]);		
