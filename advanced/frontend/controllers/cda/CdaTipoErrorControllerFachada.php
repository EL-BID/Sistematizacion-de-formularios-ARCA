...
use common\models\cda\CdaTipoErrorSearch;
...
/**
 * CdaTipoErrorControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CdaTipoError.
 */
class CdaTipoErrorControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    {
                $searchModel = new CdaTipoErrorSearch();
    ...
    /**
     * Encuentra el modelo de CdaTipoError basado en el valor de la primary key.
     * Si no encuentra respuesta, arroja una excepcion 404 HTTP.
     * @param integer $id
     * @return CdaTipoError el modelo cargado
     * @throws NotFoundHttpException si no puede ser encontrada la respuesta
     */
    protected function findModel($id)
    {
                    if (($model = CdaTipoError::findOne($id)) !== null) {
                        return $model;
                    } else {
     ...
     * @return type  CdaTipoError     */
    protected function findModelByParams($params)
    {
        if (($model = CdaTipoError::findAll($params)) !== null) {
            return $model;
        }
        else{
            return null;
    ...
    /**
     * Funcion visible para los objetos que necesiten una consulta al modelo CdaTipoError     
     * @param type $params contiene array con valores de query a columnas de la tabla
     * @return type CdaTipoError     */
     public function cargaCdaTipoError($params){
