...
use common\models\hidricos\PsActvidadRuta;
/**
 * Este es el unit test para la clase "ps_actvidad_ruta".
 *
 ...
 * @property Rol $codRol
 */
class PsActvidadRutaTest extends \Codeception\Test\Unit
{
    ...
    {                                                                                        
        ...
        $this->assertNotNull($tester,                                                          
            'PsActvidadRuta  Errors no se puede insertar en la base de datos.'); 
            */
    ...
    {                                                                                        
        ...
        $this->assertNotNull($tester,                                                          
            'PsActvidadRuta No se puede consultar en la base de datos, retorna nulo produciendose un error'); 
             /** Es posible tambien relizr con asserts, ejemplos
            en caso de un  retorno de un valor en caso de esperar nulo
        $this->assertNull($tester,                                                          
            'PsActvidadRuta Ee puede consultar en la base de datos.');   */
    ...
    {
        $table= PsActvidadRuta::tableName();
