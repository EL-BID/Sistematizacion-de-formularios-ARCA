...
/**
 * Este es el unit test para la clase "fd_detalle_valores_publicos".
 *
 * @property int4 $id_detalle_valores_publicos
 * @property int4 $codigo
 ...
 */
class FdDetalleValoresPublicosTest extends \Codeception\Test\Unit
{
    ...
    {                                                                                        
        $tester = new FdDetalleValoresPublicos();
        $tester->id_detalle_valores_publicos = "Ingresar valor de pruebas para el campo id_detalle_valores_publicos de tipo int4";
        $tester->codigo = "Ingresar valor de pruebas para el campo codigo de tipo int4";
    ...
    {                                                                                        
        ...
        $this->assertNotNull($tester,                                                          
            'FdDetalleValoresPublicos  Errors no se puede insertar en la base de datos.'); 
            */
    ...
    {                                                                                        
        $tester = FdDetalleValoresPublicos::findOne(                                                               
        [
        ...
        $this->assertNotNull($tester,                                                          
            'FdDetalleValoresPublicos No se puede consultar en la base de datos, retorna nulo produciendose un error'); 
             /** Es posible tambien relizr con asserts, ejemplos
            en caso de un  retorno de un valor en caso de esperar nulo
        $this->assertNull($tester,                                                          
            'FdDetalleValoresPublicos Ee puede consultar en la base de datos.');   */
    ...
    {
        $table= FdDetalleValoresPublicos::tableName();
   ...
   {
         expect($tester->id_detalle_valores_publicos)->equals('Ingresar valor de pruebas para el campo id_detalle_valores_publicos de tipo int4');
         expect($tester->codigo)->equals('Ingresar valor de pruebas para el campo codigo de tipo int4');
