 ...
 * @property int4 $plazo_alerta
 * @property varchar $campo_fecha_alerta
 *
...
class PsActividadTest extends \Codeception\Test\Unit
{
    ...
    {                                                                                        
        ...
        $tester->plazo_alerta = "Ingresar valor de pruebas para el campo plazo_alerta de tipo int4";
        $tester->campo_fecha_alerta = "Ingresar valor de pruebas para el campo campo_fecha_alerta de tipo varchar";
   ...
   public function testModelProperty($tester)
   {
         ...
         expect($tester->plazo_alerta)->equals('Ingresar valor de pruebas para el campo plazo_alerta de tipo int4');
         expect($tester->campo_fecha_alerta)->equals('Ingresar valor de pruebas para el campo campo_fecha_alerta de tipo varchar');
      }
