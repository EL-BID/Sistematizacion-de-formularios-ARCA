 ...
 */
class FdUbicacion_var_ap extends ModelPry
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['cod_canton','cod_provincia','cod_parroquia','id_conjunto_respuesta','id_capitulo'],'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'cod_canton' => 'Código Canton',
            'cod_provincia' => 'Código Provincia',            
            'cod_centro_atencion_ciudadano' => 'Cod Centro Atencion Ciudadano',
            'descripcion_ubicacion' => 'Descripción Ubicacion',
