...
class Pqrs extends ModelPry
{
    ...
    public function rules()
    {
        return [
            ...
            [['fecha_recepcion', 'sol_nombres', 'sol_doc_identificacion', 'sol_direccion', 'sol_email', 'sol_telefono', 'aquien_dirige', 'descripcion_peticion'], 'required', 'on' => 'sc_quejas', 'message' => 'Campo Obligatorio'],
            [['fecha_recepcion', 'sol_nombres', 'sol_doc_identificacion', 'sol_direccion', 'sol_email', 'sol_telefono', 'aquien_dirige', 'descripcion_peticion'], 'required', 'on' => 'sc_denuncia', 'message' => 'Campo Obligatorio'],
            [['fecha_recepcion', 'sol_nombres', 'sol_doc_identificacion', 'sol_direccion', 'sol_email', 'sol_telefono', 'aquien_dirige', 'descripcion_peticion'], 'required', 'on' => 'sc_felicitacion', 'message' => 'Campo Obligatorio'],
            [['id_cproceso'], 'integer'],
            [['sol_doc_identificacion'], 'match', 'pattern' => '/^[0-9]{10}$/', 'message' => 'Solo números, 10 caracteres'],
            [['en_nom_ruc'], 'match', 'pattern' => '/^[0-9]{13}$/', 'message' => 'Solo números, 13 caracteres'],
            ...
            [['sol_email'], 'email'],
            [['sol_nombres', 'sol_direccion', 'en_nom_nombres', 'en_nom_direccion', 'en_nom_email', 'aquien_dirige', 'por_quien_qrc', 'lugar_hechos', 'denunc_nombre', 'denunc_direccion'], 'string', 'max' => 500],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'naracion_hechos' => 'Narracion Hechos',
