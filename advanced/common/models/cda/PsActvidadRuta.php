...
/**
 * Este es el modelo para la clase "ps_actvidad_ruta".
 *
 ...
 * @property integer $id_actividad_ruta
 *
 ...
 * @property Rol $codRol
 */
class PsActvidadRuta extends ModelPry
{
    ...
    public function rules()
    {
        return [
            ...
            [['id_actividad_origen', 'id_actividad_destino', 'id_eproceso', 'id_actividad_ruta'], 'integer'],
