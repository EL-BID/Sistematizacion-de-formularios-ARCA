...
class PsCproceso extends ModelPry
{
    ...
    {
        return [
            [['ult_id_eproceso', 'id_proceso','id_modulo','tipo_documento_quipux','ult_id_usuario','asunto_quipux','numero','id_usuario','num_quipux','fecha_registro_quipux'], 'default', 'value' => null],
            [['ult_id_eproceso', 'id_usuario','id_proceso', 'id_modulo', 'ult_id_actividad','ult_id_usuario'], 'integer'],
            [['fecha_registro_quipux', 'ult_fecha_actividad', 'ult_fecha_estado','fecha_solicitud'], 'string'],
            [['num_quipux'], 'string', 'max' => 500],
            [['asunto_quipux'], 'string', 'max' => 4000],
            [['tipo_documento_quipux'], 'string', 'max' => 50],
            ...
            [['numero','num_quipux'], 'required', 'on' => 'pscprocesoarca'],
    ...
    {
        return $this->hasMany(Cda::className(), ['id_cproceso_arca' => 'id_cproceso']);
    }
    ...
    {
        return $this->hasMany(Cda::className(), ['id_cproceso_senagua' => 'id_cproceso']);
    }
