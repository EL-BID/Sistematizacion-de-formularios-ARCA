...
use Yii;
use backend\controllers\notificaciones\CorTipoDestinatarioControllerFachada;
/**
 * CorTipoDestinatarioControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CorTipoDestinatario.
 */
class CorTipoDestinatarioControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CorTipoDestinatarioControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\notificaciones\CorTipoDestinatarioControllerFachada', $tester);
    ...
    /**
     * Presenta un dato unico en el modelo CorTipoDestinatario.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Crea un nuevo dato sobre el modelo CorTipoDestinatario .
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\notificaciones\CorTipoDestinatarioControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CorTipoDestinatarioControllerFachada' => [
                                'id_tdestinatario' => 'Ingresar valor de pruebas para el campo id_tdestinatario de tipo int4',
                             'nom_tdestinatario' => 'Ingresar valor de pruebas para el campo nom_tdestinatario de tipo varchar',
                          ]];
     ...
     /**
     * Modifica un dato existente en el modelo CorTipoDestinatario.
    ...
    public function testActionUpdate($id)
    {
     ...
     /**
     * Deletes an existing CorTipoDestinatario model.
