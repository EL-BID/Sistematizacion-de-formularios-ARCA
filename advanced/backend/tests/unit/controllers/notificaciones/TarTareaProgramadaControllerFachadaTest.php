...
/**
 * TarTareaProgramadaControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo TarTareaProgramada.
 */
class TarTareaProgramadaControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  TarTareaProgramadaControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\notificaciones\TarTareaProgramadaControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\notificaciones\TarTareaProgramadaControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['TarTareaProgramadaControllerFachada' => [
                                'id_tarea_programada' => 'Ingresar valor de pruebas para el campo id_tarea_programada de tipo int4',
                             'nom_tarea_programada' => 'Ingresar valor de pruebas para el campo nom_tarea_programada de tipo varchar',
                             'fecha_inicio' => 'Ingresar valor de pruebas para el campo fecha_inicio de tipo date',
                             'fecha_termina' => 'Ingresar valor de pruebas para el campo fecha_termina de tipo date',
