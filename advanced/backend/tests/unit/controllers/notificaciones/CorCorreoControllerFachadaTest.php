...
/**
 * CorCorreoControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CorCorreo.
 */
class CorCorreoControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CorCorreoControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\notificaciones\CorCorreoControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\notificaciones\CorCorreoControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CorCorreoControllerFachada' => [
                                'id_correo' => 'Ingresar valor de pruebas para el campo id_correo de tipo int4',
                             'nom_correo' => 'Ingresar valor de pruebas para el campo nom_correo de tipo varchar',
                             'asunto' => 'Ingresar valor de pruebas para el campo asunto de tipo varchar',
                             'cuerpo' => 'Ingresar valor de pruebas para el campo cuerpo de tipo text',
