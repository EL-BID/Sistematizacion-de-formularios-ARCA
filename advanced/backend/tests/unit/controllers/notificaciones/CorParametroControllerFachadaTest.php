...
/**
 * CorParametroControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CorParametro.
 */
class CorParametroControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CorParametroControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\notificaciones\CorParametroControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\notificaciones\CorParametroControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CorParametroControllerFachada' => [
                                'id_parametro' => 'Ingresar valor de pruebas para el campo id_parametro de tipo int4',
                             'nom_parametro' => 'Ingresar valor de pruebas para el campo nom_parametro de tipo varchar',
                             'val_defecto' => 'Ingresar valor de pruebas para el campo val_defecto de tipo varchar',
                             'consulta_sql' => 'Ingresar valor de pruebas para el campo consulta_sql de tipo text',
