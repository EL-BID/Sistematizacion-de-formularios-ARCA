...
use Yii;
use backend\controllers\notificaciones\CorTipoParametroControllerFachada;
/**
 * CorTipoParametroControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CorTipoParametro.
 */
class CorTipoParametroControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CorTipoParametroControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\notificaciones\CorTipoParametroControllerFachada', $tester);
    ...
    /**
     * Presenta un dato unico en el modelo CorTipoParametro.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Crea un nuevo dato sobre el modelo CorTipoParametro .
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\notificaciones\CorTipoParametroControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CorTipoParametroControllerFachada' => [
                                'id_tparametro' => 'Ingresar valor de pruebas para el campo id_tparametro de tipo int4',
                             'nom_tparametro' => 'Ingresar valor de pruebas para el campo nom_tparametro de tipo varchar',
                          ]];
     ...
     /**
     * Modifica un dato existente en el modelo CorTipoParametro.
    ...
    public function testActionUpdate($id)
    {
     ...
     /**
     * Deletes an existing CorTipoParametro model.
