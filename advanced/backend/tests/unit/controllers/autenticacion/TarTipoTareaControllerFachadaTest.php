 ...
 */
class TarTipoTareaControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  TarTipoTareaControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\autenticacion\TarTipoTareaControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\autenticacion\TarTipoTareaControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['TarTipoTareaControllerFachada' => [
                                'id_ttarea' => 'Ingresar valor de pruebas para el campo id_ttarea de tipo int4',
                             'nom_ttarea' => 'Ingresar valor de pruebas para el campo nom_ttarea de tipo varchar',
                          ]];
