...
use Yii;
use backend\controllers\poc\TrPeriodoControllerFachada;
/**
 * TrPeriodoControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo TrPeriodo.
 */
class TrPeriodoControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  TrPeriodoControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\TrPeriodoControllerFachada', $tester);
    ...
    /**
     * Presenta un dato unico en el modelo TrPeriodo.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Crea un nuevo dato sobre el modelo TrPeriodo .
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\TrPeriodoControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['TrPeriodoControllerFachada' => [
                                'id_periodo' => 'Ingresar valor de pruebas para el campo id_periodo de tipo int4',
                             'nom_periodo' => 'Ingresar valor de pruebas para el campo nom_periodo de tipo varchar',
                             'identificador' => 'Ingresar valor de pruebas para el campo identificador de tipo varchar',
                             'vigencia' => 'Ingresar valor de pruebas para el campo vigencia de tipo int4',
     ...
     /**
     * Modifica un dato existente en el modelo TrPeriodo.
    ...
    public function testActionUpdate($id)
    {
     ...
     /**
     * Deletes an existing TrPeriodo model.
