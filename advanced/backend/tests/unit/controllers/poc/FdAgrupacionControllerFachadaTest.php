...
use Yii;
use backend\controllers\poc\FdAgrupacionControllerFachada;
/**
 * FdAgrupacionControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdAgrupacion.
 */
class FdAgrupacionControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdAgrupacionControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\FdAgrupacionControllerFachada', $tester);
    ...
    /**
     * Presenta un dato unico en el modelo FdAgrupacion.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Crea un nuevo dato sobre el modelo FdAgrupacion .
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\FdAgrupacionControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdAgrupacionControllerFachada' => [
                                'id_agrupacion' => 'Ingresar valor de pruebas para el campo id_agrupacion de tipo int4',
                             'nom_agrupacion' => 'Ingresar valor de pruebas para el campo nom_agrupacion de tipo varchar',
                             'id_tagrupacion' => 'Ingresar valor de pruebas para el campo id_tagrupacion de tipo int4',
                             'num_col' => 'Ingresar valor de pruebas para el campo num_col de tipo int4',
     ...
     /**
     * Modifica un dato existente en el modelo FdAgrupacion.
    ...
    public function testActionUpdate($id)
    {
     ...
     /**
     * Deletes an existing FdAgrupacion model.
