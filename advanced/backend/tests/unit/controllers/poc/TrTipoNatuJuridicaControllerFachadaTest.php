...
/**
 * TrTipoNatuJuridicaControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo TrTipoNatuJuridica.
 */
class TrTipoNatuJuridicaControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  TrTipoNatuJuridicaControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\TrTipoNatuJuridicaControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\TrTipoNatuJuridicaControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['TrTipoNatuJuridicaControllerFachada' => [
                                'id_natu_juridica' => 'Ingresar valor de pruebas para el campo id_natu_juridica de tipo int4',
                             'nom_natu_juridica' => 'Ingresar valor de pruebas para el campo nom_natu_juridica de tipo varchar',
                          ]];
