...
use Yii;
use backend\controllers\poc\TrTipoPeriodoControllerFachada;
/**
 * TrTipoPeriodoControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo TrTipoPeriodo.
 */
class TrTipoPeriodoControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  TrTipoPeriodoControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\TrTipoPeriodoControllerFachada', $tester);
    ...
    /**
     * Presenta un dato unico en el modelo TrTipoPeriodo.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Crea un nuevo dato sobre el modelo TrTipoPeriodo .
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\TrTipoPeriodoControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['TrTipoPeriodoControllerFachada' => [
                                'id_tperiodo' => 'Ingresar valor de pruebas para el campo id_tperiodo de tipo int4',
                             'nom_tperiodo' => 'Ingresar valor de pruebas para el campo nom_tperiodo de tipo varchar',
                          ]];
     ...
     /**
     * Modifica un dato existente en el modelo TrTipoPeriodo.
    ...
    public function testActionUpdate($id)
    {
     ...
     /**
     * Deletes an existing TrTipoPeriodo model.
