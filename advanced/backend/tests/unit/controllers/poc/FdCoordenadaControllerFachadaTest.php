...
use Yii;
use backend\controllers\poc\FdCoordenadaControllerFachada;
/**
 * FdCoordenadaControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdCoordenada.
 */
class FdCoordenadaControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdCoordenadaControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\FdCoordenadaControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\FdCoordenadaControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdCoordenadaControllerFachada' => [
                                'id_coordenada' => 'Ingresar valor de pruebas para el campo id_coordenada de tipo int4',
                             'x' => 'Ingresar valor de pruebas para el campo x de tipo numeric',
                             'y' => 'Ingresar valor de pruebas para el campo y de tipo numeric',
                             'altura' => 'Ingresar valor de pruebas para el campo altura de tipo numeric',
