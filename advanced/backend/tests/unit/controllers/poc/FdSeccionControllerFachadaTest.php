...
use Yii;
use backend\controllers\poc\FdSeccionControllerFachada;
/**
 * FdSeccionControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdSeccion.
 */
class FdSeccionControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdSeccionControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('backend\controllers\poc\FdSeccionControllerFachada', $tester);
    ...
    /**
     * Presenta un dato unico en el modelo FdSeccion.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Crea un nuevo dato sobre el modelo FdSeccion .
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('backend\controllers\poc\FdSeccionControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdSeccionControllerFachada' => [
                                'id_seccion' => 'Ingresar valor de pruebas para el campo id_seccion de tipo int4',
                             'nom_seccion' => 'Ingresar valor de pruebas para el campo nom_seccion de tipo varchar',
                             'orden' => 'Ingresar valor de pruebas para el campo orden de tipo int4',
                             'id_capitulo' => 'Ingresar valor de pruebas para el campo id_capitulo de tipo int4',
     ...
     /**
     * Modifica un dato existente en el modelo FdSeccion.
    ...
    public function testActionUpdate($id)
    {
     ...
     /**
     * Deletes an existing FdSeccion model.
