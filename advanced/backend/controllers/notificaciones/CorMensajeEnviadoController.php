...
/**
 * CorMensajeEnviadoController implementa las acciones a través del sistema CRUD para el modelo CorMensajeEnviado.
 */
class CorMensajeEnviadoController extends ControllerPry
{
  //private $facade =    CorMensajeEnviadoControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  CorMensajeEnviadoControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_mensaje_enviado]);		
