...
/**
 * CorDestinatarioController implementa las acciones a través del sistema CRUD para el modelo CorDestinatario.
 */
class CorDestinatarioController extends ControllerPry
{
  //private $facade =    CorDestinatarioControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  CorDestinatarioControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_destinatario]);		
