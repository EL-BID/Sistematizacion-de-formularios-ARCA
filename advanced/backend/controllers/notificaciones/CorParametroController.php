 ...
 */
class CorParametroController extends ControllerPry
{
  //private $facade =    CorParametroControllerFachada;
    ...
    {
        $facade =  new  CorParametroControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_parametro]);		
