...
/**
 * CentroAtencionCiudadanoController implementa las acciones a través del sistema CRUD para el modelo CentroAtencionCiudadano.
 */
class CentroAtencionCiudadanoController extends ControllerPry
{
  //private $facade =    CentroAtencionCiudadanoControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  CentroAtencionCiudadanoControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->cod_centro_atencion_ciudadano]);		
