...
/**
 * FdModuloController implementa las acciones a través del sistema CRUD para el modelo FdModulo.
 */
class FdModuloController extends ControllerPry
{
  //private $facade =    FdModuloControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdModuloControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_modulo]);		
