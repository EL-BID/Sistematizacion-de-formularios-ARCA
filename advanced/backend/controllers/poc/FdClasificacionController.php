...
use Yii;
use backend\controllers\poc\FdClasificacionControllerFachada;
...
/**
 * FdClasificacionController implementa las acciones a través del sistema CRUD para el modelo FdClasificacion.
 */
class FdClasificacionController extends ControllerPry
{
  //private $facade =    FdClasificacionControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdClasificacionControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_clasificacion]);		
