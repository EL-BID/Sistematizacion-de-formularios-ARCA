...
/**
 * FdDatosGeneralesController implementa las acciones a través del sistema CRUD para el modelo FdDatosGenerales.
 */
class FdDatosGeneralesController extends ControllerPry
{
  //private $facade =    FdDatosGeneralesControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdDatosGeneralesControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_datos_generales]);		
