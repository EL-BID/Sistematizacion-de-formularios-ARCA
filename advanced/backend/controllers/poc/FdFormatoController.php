...
/**
 * FdFormatoController implementa las acciones a través del sistema CRUD para el modelo FdFormato.
 */
class FdFormatoController extends ControllerPry
{
  //private $facade =    FdFormatoControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdFormatoControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_formato]);		
