...
/**
 * FdConjuntoRespuestaController implementa las acciones a través del sistema CRUD para el modelo FdConjuntoRespuesta.
 */
class FdConjuntoRespuestaController extends ControllerPry
{
  //private $facade =    FdConjuntoRespuestaControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdConjuntoRespuestaControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_conjunto_respuesta]);		
