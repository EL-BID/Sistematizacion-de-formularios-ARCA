...
use common\models\poc\FdConjuntoRespuestaSearch;
...
/**
 * FdConjuntoRespuestaControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdConjuntoRespuesta.
 */
class FdConjuntoRespuestaControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    {
                $searchModel = new FdConjuntoRespuestaSearch();
    ...
    /**
     * Finds the FdConjuntoRespuesta model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return FdConjuntoRespuesta the loaded model
