...
/**
 * SopSoportesController implementa las acciones a través del sistema CRUD para el modelo SopSoportes.
 */
class SopSoportesController extends ControllerPry
{
  //private $facade =    SopSoportesControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  SopSoportesControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_soportes]);		
