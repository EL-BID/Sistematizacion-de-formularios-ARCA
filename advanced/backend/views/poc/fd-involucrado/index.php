...
<div class="fd-involucrado-index">
    ...
    <p>
        <?= Html::button('Create Fd Involucrado', 
        ['value' =>Url::to(['poc/fd-involucrado/create']), 'title' => 'Create Fd Involucrado',
        ...
        'columns' => [
            ...
            [
                ...
                'buttons' => [
                    ...
                    }, //Primera columna encontrada id_involucrado                    
                    'delete' => function($url, $model){
                            $url2 = Url::toRoute(['poc/fd-involucrado/deletep','id' => $model->id_involucrado],true);
