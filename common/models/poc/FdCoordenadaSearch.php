 ...
 */
class FdCoordenadaSearch extends FdCoordenada
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_coordenada', 'id_tcoordenada', 'id_conjunto_respuesta', 'id_pregunta', 'id_respuesta'], 'integer'],
