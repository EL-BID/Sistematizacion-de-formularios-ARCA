 ...
 */
class ConsultaCiudadana extends ModelPry
{
...
/*===========================================================================================================================================*/ 
   ...
   function __construct($_arraycap,$v_preguntans) {
...
/*===========================================================================================================================================*/ 
    ...
    public function tipo_3($v_data,$l_array){
        ...
        //Yii::trace("aqui que llega 4".$l_array."::".$v_data['respuesta'],"DEBUG");
    ...
    public function upload($_rpta)
    {
        ...
        foreach ($this->{''.$_rpta} as $file) {
            ...
            if($file->saveAs('uploadfolder/files/' . $file->baseName . '.' . $file->extension)){
                ...
                $this->folder = "uploadfolder/files/";
