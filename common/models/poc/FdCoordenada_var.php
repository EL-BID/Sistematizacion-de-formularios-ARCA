 ...
 */
class FdCoordenada_var extends ModelPry
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_tcoordenada','id_conjunto_respuesta', 'x', 'y','altura','id_capitulo'], 'required'],
            [['id_tcoordenada', 'id_conjunto_respuesta', 'id_pregunta', 'id_respuesta','id_capitulo'], 'integer'],
            [['x', 'y', 'altura', 'longitud', 'latitud'], formatnumber::className(),"params"=>["format"=>"##.#####"]],
