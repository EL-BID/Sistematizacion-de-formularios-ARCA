...
use common\models\poc\FdTratemientoAguaDesinfeccionApscom;
/**
 * Este es el unit test para la clase "fd_tratemiento_agua_desinfeccion_apscom".
 *
 ...
 */
class FdTratemientoAguaDesinfeccionApscomTest extends \Codeception\Test\Unit
{
    ...
    {                                                                                        
        $tester = new FdTratemientoAguaDesinfeccionApscom();
    ...
    {                                                                                        
        ...
        $this->assertNotNull($tester,                                                          
            'FdTratemientoAguaDesinfeccionApscom  Errors no se puede insertar en la base de datos.'); 
            */
    ...
    {                                                                                        
        $tester = FdTratemientoAguaDesinfeccionApscom::findOne(                                                               
        [
        ...
        $this->assertNotNull($tester,                                                          
            'FdTratemientoAguaDesinfeccionApscom No se puede consultar en la base de datos, retorna nulo produciendose un error'); 
             /** Es posible tambien relizr con asserts, ejemplos
            en caso de un  retorno de un valor en caso de esperar nulo
        $this->assertNull($tester,                                                          
            'FdTratemientoAguaDesinfeccionApscom Ee puede consultar en la base de datos.');   */
    ...
    {
        $table= FdTratemientoAguaDesinfeccionApscom::tableName();
