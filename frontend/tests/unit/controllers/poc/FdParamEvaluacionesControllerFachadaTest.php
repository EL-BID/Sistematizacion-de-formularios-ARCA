...
/**
 * FdParamEvaluacionesControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdParamEvaluaciones.
 */
class FdParamEvaluacionesControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdParamEvaluacionesControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\poc\FdParamEvaluacionesControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\poc\FdParamEvaluacionesControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdParamEvaluacionesControllerFachada' => [
                                'id_evaluacion' => 'Ingresar valor de pruebas para el campo id_evaluacion de tipo int4',
                             'componente' => 'Ingresar valor de pruebas para el campo componente de tipo varchar',
                             'criterio' => 'Ingresar valor de pruebas para el campo criterio de tipo varchar',
                             'item' => 'Ingresar valor de pruebas para el campo item de tipo int4',
