...
/**
 * FdTrataguaDesinfeccionApscomControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdTrataguaDesinfeccionApscom.
 */
class FdTrataguaDesinfeccionApscomControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdTrataguaDesinfeccionApscomControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\poc\FdTrataguaDesinfeccionApscomControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\poc\FdTrataguaDesinfeccionApscomControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdTrataguaDesinfeccionApscomControllerFachada' => [
                                'id_trat_aguadesinf_apscom' => 'Ingresar valor de pruebas para el campo id_trat_aguadesinf_apscom de tipo int4',
                             'ubicacion_lug_tratamiento' => 'Ingresar valor de pruebas para el campo ubicacion_lug_tratamiento de tipo varchar',
                             'realiza_desinfeccion' => 'Ingresar valor de pruebas para el campo realiza_desinfeccion de tipo int4',
                             'metodo_desinfeccion' => 'Ingresar valor de pruebas para el campo metodo_desinfeccion de tipo int4',
