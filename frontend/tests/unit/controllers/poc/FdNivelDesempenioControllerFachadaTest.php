...
use Yii;
use frontend\controllers\poc\FdNivelDesempenioControllerFachada;
/**
 * FdNivelDesempenioControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdNivelDesempenio.
 */
class FdNivelDesempenioControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdNivelDesempenioControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\poc\FdNivelDesempenioControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\poc\FdNivelDesempenioControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdNivelDesempenioControllerFachada' => [
                                'id_nivel' => 'Ingresar valor de pruebas para el campo id_nivel de tipo int4',
                             'intervalo_inicio' => 'Ingresar valor de pruebas para el campo intervalo_inicio de tipo int4',
                             'intervalo_fin' => 'Ingresar valor de pruebas para el campo intervalo_fin de tipo int4',
                             'nivel_desempenio' => 'Ingresar valor de pruebas para el campo nivel_desempenio de tipo varchar',
