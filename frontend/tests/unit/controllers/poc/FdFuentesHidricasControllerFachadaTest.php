...
/**
 * FdFuentesHidricasControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdFuentesHidricas.
 */
class FdFuentesHidricasControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdFuentesHidricasControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\poc\FdFuentesHidricasControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\poc\FdFuentesHidricasControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdFuentesHidricasControllerFachada' => [
                                'id_fuentehidrica' => 'Ingresar valor de pruebas para el campo id_fuentehidrica de tipo int4',
                             'nom_fuente' => 'Ingresar valor de pruebas para el campo nom_fuente de tipo varchar',
                             'id_conjunto_respuesta' => 'Ingresar valor de pruebas para el campo id_conjunto_respuesta de tipo int4',
                             'id_pregunta' => 'Ingresar valor de pruebas para el campo id_pregunta de tipo int4',
