...
/**
 * FdRepresentantesPrestadorControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdRepresentantesPrestador.
 */
class FdRepresentantesPrestadorControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdRepresentantesPrestadorControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\poc\FdRepresentantesPrestadorControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\poc\FdRepresentantesPrestadorControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdRepresentantesPrestadorControllerFachada' => [
                                'id_representantes_prestador' => 'Ingresar valor de pruebas para el campo id_representantes_prestador de tipo int4',
                             'nombre' => 'Ingresar valor de pruebas para el campo nombre de tipo varchar',
                             'cargo' => 'Ingresar valor de pruebas para el campo cargo de tipo varchar',
                             'telefono' => 'Ingresar valor de pruebas para el campo telefono de tipo int4',
