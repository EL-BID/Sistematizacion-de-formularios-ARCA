...
/**
 * FdObrasCaptacionRiegoControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdObrasCaptacionRiego.
 */
class FdObrasCaptacionRiegoControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdObrasCaptacionRiegoControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\poc\FdObrasCaptacionRiegoControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\poc\FdObrasCaptacionRiegoControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdObrasCaptacionRiegoControllerFachada' => [
                                'id_obracaptacion' => 'Ingresar valor de pruebas para el campo id_obracaptacion de tipo int4',
                             'numero_obras' => 'Ingresar valor de pruebas para el campo numero_obras de tipo int4',
                             'tipo_obra' => 'Ingresar valor de pruebas para el campo tipo_obra de tipo int4',
                             'especifique' => 'Ingresar valor de pruebas para el campo especifique de tipo varchar',
