...
use Yii;
use frontend\controllers\poc\FdResulEvaluacionesControllerFachada;
/**
 * FdResulEvaluacionesControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdResulEvaluaciones.
 */
class FdResulEvaluacionesControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdResulEvaluacionesControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\poc\FdResulEvaluacionesControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\poc\FdResulEvaluacionesControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdResulEvaluacionesControllerFachada' => [
                                'id_resul_evaluaciones' => 'Ingresar valor de pruebas para el campo id_resul_evaluaciones de tipo int4',
                             'id_evaluacion' => 'Ingresar valor de pruebas para el campo id_evaluacion de tipo int4',
                             'puntaje' => 'Ingresar valor de pruebas para el campo puntaje de tipo numeric',
                             'id_conjunto_respuesta' => 'Ingresar valor de pruebas para el campo id_conjunto_respuesta de tipo int4',
