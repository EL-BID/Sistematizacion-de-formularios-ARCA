...
/**
 * FdParamIndicadoresControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdParamIndicadores.
 */
class FdParamIndicadoresControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdParamIndicadoresControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\poc\FdParamIndicadoresControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\poc\FdParamIndicadoresControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdParamIndicadoresControllerFachada' => [
                                'id_indicador' => 'Ingresar valor de pruebas para el campo id_indicador de tipo int4',
                             'tipo_indicador' => 'Ingresar valor de pruebas para el campo tipo_indicador de tipo varchar',
                             'item' => 'Ingresar valor de pruebas para el campo item de tipo int4',
                             'indicador' => 'Ingresar valor de pruebas para el campo indicador de tipo varchar',
