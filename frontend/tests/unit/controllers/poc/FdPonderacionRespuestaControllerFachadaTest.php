...
use Yii;
use frontend\controllers\poc\FdPonderacionRespuestaControllerFachada;
/**
 * FdPonderacionRespuestaControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdPonderacionRespuesta.
 */
class FdPonderacionRespuestaControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  FdPonderacionRespuestaControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\poc\FdPonderacionRespuestaControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\poc\FdPonderacionRespuestaControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['FdPonderacionRespuestaControllerFachada' => [
                                'id_ponderacion_resp' => 'Ingresar valor de pruebas para el campo id_ponderacion_resp de tipo int4',
                             'id_tpondera' => 'Ingresar valor de pruebas para el campo id_tpondera de tipo int4',
                             'descripcion_ponderacion' => 'Ingresar valor de pruebas para el campo descripcion_ponderacion de tipo varchar',
                             'valor' => 'Ingresar valor de pruebas para el campo valor de tipo numeric',
