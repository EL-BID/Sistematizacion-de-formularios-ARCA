...
/**
 * CdaCartografiaControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CdaCartografia.
 */
class CdaCartografiaControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CdaCartografiaControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\CdaCartografiaControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\CdaCartografiaControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CdaCartografiaControllerFachada' => [
                                'id_cartografia' => 'Ingresar valor de pruebas para el campo id_cartografia de tipo int4',
                             'nom_cartografia' => 'Ingresar valor de pruebas para el campo nom_cartografia de tipo varchar',
                          ]];
