...
/**
 * CdaEstacionMeteorologicaControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CdaEstacionMeteorologica.
 */
class CdaEstacionMeteorologicaControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CdaEstacionMeteorologicaControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\CdaEstacionMeteorologicaControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\CdaEstacionMeteorologicaControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CdaEstacionMeteorologicaControllerFachada' => [
                                'id_emeteorologica' => 'Ingresar valor de pruebas para el campo id_emeteorologica de tipo varchar',
                             'nom_emeteorologica' => 'Ingresar valor de pruebas para el campo nom_emeteorologica de tipo varchar',
                          ]];
