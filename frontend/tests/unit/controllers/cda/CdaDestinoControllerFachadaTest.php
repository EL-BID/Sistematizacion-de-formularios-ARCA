...
use Yii;
use frontend\controllers\cda\CdaDestinoControllerFachada;
/**
 * CdaDestinoControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo CdaDestino.
 */
class CdaDestinoControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  CdaDestinoControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\CdaDestinoControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\CdaDestinoControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['CdaDestinoControllerFachada' => [
                                'id_destino' => 'Ingresar valor de pruebas para el campo id_destino de tipo int4',
                             'nom_destino' => 'Ingresar valor de pruebas para el campo nom_destino de tipo varchar',
                          ]];
