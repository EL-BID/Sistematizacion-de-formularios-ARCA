...
/**
 * PsActividadControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo PsActividad.
 */
class PsActividadControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  PsActividadControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\cda\PsActividadControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\cda\PsActividadControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['PsActividadControllerFachada' => [
                                'id_actividad' => 'Ingresar valor de pruebas para el campo id_actividad de tipo int4',
                             'nom_actividad' => 'Ingresar valor de pruebas para el campo nom_actividad de tipo varchar',
                             'orden' => 'Ingresar valor de pruebas para el campo orden de tipo int4',
                             'id_proceso' => 'Ingresar valor de pruebas para el campo id_proceso de tipo int4',
