...
use Yii;
use frontend\controllers\PsHistoricoEstadosControllerFachada;
/**
 * PsHistoricoEstadosControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo PsHistoricoEstados.
 */
class PsHistoricoEstadosControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  PsHistoricoEstadosControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('frontend\controllers\PsHistoricoEstadosControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('frontend\controllers\PsHistoricoEstadosControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['PsHistoricoEstadosControllerFachada' => [
                                'id_hisotrico_cproceso' => 'Ingresar valor de pruebas para el campo id_hisotrico_cproceso de tipo int4',
                             'fecha_estado' => 'Ingresar valor de pruebas para el campo fecha_estado de tipo date',
                             'observaciones' => 'Ingresar valor de pruebas para el campo observaciones de tipo varchar',
                             'id_eproceso' => 'Ingresar valor de pruebas para el campo id_eproceso de tipo int4',
