...
/**
 * PsCargueController implementa las acciones a través del sistema CRUD para el modelo PsCargue.
 */
class PsCargueController extends ControllerPry
{
  //private $facade =    PsCargueControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  PsCargueControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'index', 'id' => $model->id_cargues]);		
    ...
    public function actionUpdate($id)
    {
        ...
        if ($modelE['update'] == 'True') {
            ...
            return $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_cargues]);
