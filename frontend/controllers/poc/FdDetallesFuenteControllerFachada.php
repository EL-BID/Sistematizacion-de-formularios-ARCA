...
use common\models\poc\FdDetallesFuenteSearch;
...
/**
 * FdDetallesFuenteControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdDetallesFuente.
 */
class FdDetallesFuenteControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    {
                $searchModel = new FdDetallesFuenteSearch();
 ...
 if(!empty($id_cnj_rpta)){
    ...
    /**
     * Encuentra el modelo de FdDetallesFuente basado en el valor de la primary key.
     * Si no encuentra respuesta, arroja una excepcion 404 HTTP.
     * @param integer $id
     * @return FdDetallesFuente el modelo cargado
     * @throws NotFoundHttpException si no puede ser encontrada la respuesta
     */
    protected function findModel($id)
    {
                    if (($model = FdDetallesFuente::findOne($id)) !== null) {
                        return $model;
                    } else {
     ...
     * @return type  FdDetallesFuente     */
    protected function findModelByParams($params)
    {
        if (($model = FdDetallesFuente::findAll($params)) !== null) {
            return $model;
        }
        else{
            return null;
    ...
    /**
     * Funcion visible para los objetos que necesiten una consulta al modelo FdDetallesFuente     
     * @param type $params contiene array con valores de query a columnas de la tabla
     * @return type FdDetallesFuente     */
     public function cargaFdDetallesFuente($params){
