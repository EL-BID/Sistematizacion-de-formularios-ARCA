...
/**
 * FdResulEvaluacionesController implementa las acciones a través del sistema CRUD para el modelo FdResulEvaluaciones.
 */
class FdResulEvaluacionesController extends ControllerPry
{
  //private $facade =    FdResulEvaluacionesControllerFachada;
    /**
     * @inheritdoc
     */
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_resul_evaluaciones]);		
