...
/**
 * FdDatosAguaPotableController implementa las acciones a través del sistema CRUD para el modelo FdDatosAguaPotable.
 */
class FdDatosAguaPotableController extends ControllerPry
{
  //private $facade =    FdDatosAguaPotableControllerFachada;
    /**
     * {@inheritdoc}
     */
    public function behaviors()
    {
        $facade =  new  FdDatosAguaPotableControllerFachada();
    ...
    public function actionIndexdetcapitulo($id_fmt, $id_version, $id_conj_prta, $id_cnj_rpta, $id_capitulo, $id_prta, $id_rpta, $numerar, $nom_prta, $migadepan, $estado, $capitulo, $provincia, $cantones, $parroquias, $periodos, $antvista, $focus)
    {
        ...
        if (empty($id_rpta)) {
            ...
            $rpta_exists = FdRespuesta::find()
                          ...
                          ->andwhere(['=', 'fd_respuesta.id_tpregunta', '20'])
        ...
        $facade = new FdDatosAguaPotableControllerFachada();
        //FdInvolucradoSearch
        $_busquedap = ['FdDatosAguaPotableSearch' => [
...
/*-*-*-*-*-*-*-*-*-* FIN DEL CODIGO PARA PANTALLA N REGISTROS *-*-*-*-*-*-*-*-*-*-*-*-*-*/    
    ...
    public function actionUpdate($id)
    {
        ...
        if ($modelE['update'] == 'True') {
            ...
            return $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_datos_agua_potable]);
