...
use common\models\poc\FdConduccionImpulsionApscomSearch;
...
/**
 * FdConduccionImpulsionApscomControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdConduccionImpulsionApscom.
 */
class FdConduccionImpulsionApscomControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    {
                $searchModel = new FdConduccionImpulsionApscomSearch();
    ...
    {
        $model = new FdConduccionImpulsionApscom();
    ...
    /**
     * Encuentra el modelo de FdConduccionImpulsionApscom basado en el valor de la primary key.
     * Si no encuentra respuesta, arroja una excepcion 404 HTTP.
     * @param integer $id
     * @return FdConduccionImpulsionApscom el modelo cargado
     * @throws NotFoundHttpException si no puede ser encontrada la respuesta
     */
    protected function findModel($id)
    {
                    if (($model = FdConduccionImpulsionApscom::findOne($id)) !== null) {
                        return $model;
                    } else {
     ...
     * @return type  FdConduccionImpulsionApscom     */
    protected function findModelByParams($params)
    {
        if (($model = FdConduccionImpulsionApscom::findAll($params)) !== null) {
            return $model;
        }
        else{
            return null;
    ...
    /**
     * Funcion visible para los objetos que necesiten una consulta al modelo FdConduccionImpulsionApscom     
     * @param type $params contiene array con valores de query a columnas de la tabla
     * @return type FdConduccionImpulsionApscom     */
     public function cargaFdConduccionImpulsionApscom($params){
