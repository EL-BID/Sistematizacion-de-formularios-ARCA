...
/**
 * FdNivelDesempenioController implementa las acciones a través del sistema CRUD para el modelo FdNivelDesempenio.
 */
class FdNivelDesempenioController extends ControllerPry
{
  //private $facade =    FdNivelDesempenioControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdNivelDesempenioControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_nivel]);		
