...
/**
 * FdConduccionImpulsionApscomController implementa las acciones a través del sistema CRUD para el modelo FdConduccionImpulsionApscom.
 */
class FdConduccionImpulsionApscomController extends ControllerPry
{
  //private $facade =    FdConduccionImpulsionApscomControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdConduccionImpulsionApscomControllerFachada;
    ...
    public function actionIndexdetcapitulo($id_fmt, $id_version, $id_conj_prta, $id_cnj_rpta, $id_capitulo, $id_prta, $id_rpta, $numerar, $nom_prta, $migadepan, $estado, $capitulo, $provincia, $cantones, $parroquias, $periodos, $antvista, $focus,$idjunta)
    {
        ...
        $facade = new FdConduccionImpulsionApscomControllerFachada();
        //FdInvolucradoSearch
        $_busquedap = ['FdConduccionImpulsionApscomSearch' => [
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_cond_impulsion_apscom]);		
