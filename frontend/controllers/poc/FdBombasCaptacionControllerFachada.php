...
use common\models\poc\FdBombasCaptacionSearch;
...
/**
 * FdBombasCaptacionControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdBombasCaptacion.
 */
class FdBombasCaptacionControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    {
                $searchModel = new FdBombasCaptacionSearch();
...
if(!empty($id_cnj_rpta)){
    ...
    /**
     * Encuentra el modelo de FdBombasCaptacion basado en el valor de la primary key.
     * Si no encuentra respuesta, arroja una excepcion 404 HTTP.
     * @param integer $id
     * @return FdBombasCaptacion el modelo cargado
     * @throws NotFoundHttpException si no puede ser encontrada la respuesta
     */
    protected function findModel($id)
    {
                    if (($model = FdBombasCaptacion::findOne($id)) !== null) {
                        return $model;
                    } else {
     ...
     * @return type  FdBombasCaptacion     */
    protected function findModelByParams($params)
    {
        if (($model = FdBombasCaptacion::findAll($params)) !== null) {
            return $model;
        }
        else{
            return null;
    ...
    /**
     * Funcion visible para los objetos que necesiten una consulta al modelo FdBombasCaptacion     
     * @param type $params contiene array con valores de query a columnas de la tabla
     * @return type FdBombasCaptacion     */
     public function cargaFdBombasCaptacion($params){
