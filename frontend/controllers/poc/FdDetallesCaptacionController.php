...
/**
 * FdDetallesCaptacionController implementa las acciones a través del sistema CRUD para el modelo FdDetallesCaptacion.
 */
class FdDetallesCaptacionController extends ControllerPry
{
  //private $facade =    FdDetallesCaptacionControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdDetallesCaptacionControllerFachada;
    ...
    public function actionIndexdetcapitulo($id_fmt, $id_version, $id_conj_prta, $id_cnj_rpta, $id_capitulo, $id_prta, $id_rpta, $numerar, $nom_prta, $migadepan, $estado, $capitulo, $provincia, $cantones, $parroquias, $periodos, $antvista, $focus, $idjunta)
    {
        ...
        if (empty($id_rpta)) {
            ...
            $rpta_exists = FdRespuesta::find()
                          ...
                          ->andwhere(['=', 'fd_respuesta.id_tpregunta', '24'])
        ...
        $facade = new FdDetallesCaptacionControllerFachada();
        //FdInvolucradoSearch
        $_busquedap = ['FdDetallesCaptacionSearch' => [
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_detalles_captacion]);		
