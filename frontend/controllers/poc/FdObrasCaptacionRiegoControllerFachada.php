...
use common\models\poc\FdObrasCaptacionRiegoSearch;
...
/**
 * FdObrasCaptacionRiegoControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo FdObrasCaptacionRiego.
 */
class FdObrasCaptacionRiegoControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
    ...
    {
                $searchModel = new FdObrasCaptacionRiegoSearch();
    ...
    {
        $model = new FdObrasCaptacionRiego();
    ...
    /**
     * Encuentra el modelo de FdObrasCaptacionRiego basado en el valor de la primary key.
     * Si no encuentra respuesta, arroja una excepcion 404 HTTP.
     * @param integer $id
     * @return FdObrasCaptacionRiego el modelo cargado
     * @throws NotFoundHttpException si no puede ser encontrada la respuesta
     */
    protected function findModel($id)
    {
                    if (($model = FdObrasCaptacionRiego::findOne($id)) !== null) {
                        return $model;
                    } else {
     ...
     * @return type  FdObrasCaptacionRiego     */
    protected function findModelByParams($params)
    {
        if (($model = FdObrasCaptacionRiego::findAll($params)) !== null) {
            return $model;
        }
        else{
            return null;
    ...
    /**
     * Funcion visible para los objetos que necesiten una consulta al modelo FdObrasCaptacionRiego     
     * @param type $params contiene array con valores de query a columnas de la tabla
     * @return type FdObrasCaptacionRiego     */
     public function cargaFdObrasCaptacionRiego($params){
