...
/**
 * FdPonderacionRespuestaController implementa las acciones a través del sistema CRUD para el modelo FdPonderacionRespuesta.
 */
class FdPonderacionRespuestaController extends ControllerPry
{
  //private $facade =    FdPonderacionRespuestaControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdPonderacionRespuestaControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_ponderacion_resp]);		
