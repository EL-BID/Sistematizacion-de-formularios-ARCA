...
use Yii;
use frontend\controllers\poc\FdCoordenadaControllerFachada;
...
/**
 * FdCoordenadaController implementa las acciones a través del sistema CRUD para el modelo FdCoordenada.
 */
class FdCoordenadaController extends ControllerPry
{
  //private $facade =    FdCoordenadaControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  FdCoordenadaControllerFachada;
    ...
    public function actionIndex()
    {
     ...
     /**
     * Lista las coordenadas ingresadas en una pregunta
    ...
    /**
     * Presenta un dato unico en el modelo FdCoordenada.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Crea un nuevo dato sobre el modelo FdCoordenada .
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_coordenada]);		
    ...
    /**
     * Funcion para crear una nueva coordenada asociada a un id_capitulo,id_pregunta, id_cnj_respuesta,id_respuesta
    ...
    */
    public function actionCreatedetcapitulo($id_fmt,$id_version,$id_conj_prta,$id_cnj_rpta,$id_capitulo,$id_prta,$id_rpta,$nom_prta,$numerar,$migadepan,$estado,$capitulo,$provincia,$cantones,$parroquias,$periodos,$antvista,$focus,$btnadd)
    {
    ...
    /**
     * Modifica un dato existente en el modelo FdCoordenada.
    ...
    public function actionUpdate($id)
    {
     ...
     /**
     * Modifica un dato existente en el modelo FdCoordenada asociado a un formato de detcapitulo
     * Si se modifica correctamente guarda setFlash, presenta la barra de progreso y envia a view con la confirmación de guardado..
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Deletes an existing FdCoordenada model.
