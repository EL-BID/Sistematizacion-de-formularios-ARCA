 ...
 */
class ClientesmodalController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function actionIndex()
    {
        ...
        return $this->render('/wiki/clientesmodal/index', [
    ...
    {
        return $this->render('/wiki/clientesmodal/view', [
            'model' => $this->findModel($id),
        ]);
    }

    /**
     * Crea un nuevo dato sobre el modelo Clientesmodal .
    ...
    public function actionCreate()
    {
		...
		if ($model->load(Yii::$app->request->post()) && $model->save()) {
		   ...
		   return $this->redirect(['progress', 'urlroute' => '/wiki/clientesmodal/view', 'id' => $model->Id]);

		}elseif (Yii::$app->request->isAjax) {
            return $this->renderAjax('/wiki/clientesmodal/create', [
                        'model' => $model
            ]);
        } else {
            return $this->render('/wiki/clientesmodal/create', [
                        'model' => $model
            ]);
        }
    }
    ...
    /**
     * Modifica un dato existente en el modelo Clientesmodal.
    ...
    public function actionUpdate($id)
    {
        ...
        elseif (Yii::$app->request->isAjax) {
            return $this->renderAjax('/wiki/clientesmodal/update', [
                        'model' => $model
            ]);
        } else {
            return $this->render('/wiki/clientesmodal/update', [
                        'model' => $model
            ]);
        }
    }
    ...
    public function actionDeletep($id)
    {
        ...
        return $this->redirect(['/wiki/clientesmodal/index']);
    }
