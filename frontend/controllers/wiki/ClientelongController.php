...
use Yii;
use common\models\wiki\Clientelongvalidator;
 ...
 */
class ClientelongController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $model = new Clientelongvalidator();
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            return $this->render('/wiki/clientelong/create', [
                'model' => $model,'msg'=>$msg,
            ]);
        }
