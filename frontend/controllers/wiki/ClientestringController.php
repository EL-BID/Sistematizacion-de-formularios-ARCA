...
use Yii;
use common\models\wiki\Clientestringvalidator;
use yii\web\Controller;
use yii\filters\VerbFilter;


class ClientestringController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $model = new Clientestringvalidator();
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            return $this->render('/wiki/clientestring/create', [
                'model' => $model,'msg'=>$msg,
            ]);
        }
