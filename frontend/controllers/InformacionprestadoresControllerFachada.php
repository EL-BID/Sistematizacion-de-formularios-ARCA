...
/**
 * InformacionprestadoresControllerFachada implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo Informacionprestadores.
 */
class InformacionprestadoresControllerFachada extends FachadaPry
{
    /**
     * @inheritdoc
     */
