...
/**
 * CdaUsoSolicitadoController implementa las acciones a través del sistema CRUD para el modelo CdaUsoSolicitado.
 */
class CdaUsoSolicitadoController extends ControllerPry
{
  //private $facade =    CdaUsoSolicitadoControllerFachada;
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        $facade =  new  CdaUsoSolicitadoControllerFachada;
    ...
    public function actionCreate()
    {
       ...
       $model = $modelE['model'];
        if ($modelE['create'] == 'True') {
            ...
            return  $this->redirect(['progress', 'urlroute' => 'view', 'id' => $model->id_uso_solicitado]);		
