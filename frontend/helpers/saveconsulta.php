    ...
    */
    ...
    function gr_tipo1($_idrespuesta,$valor){
        ...
        if(empty($_idrespuesta)){
            $g_sql="INSERT INTO $tableRpta ([[ra_fecha]],[[id_conjunto_respuesta]],[[id_pregunta]],[[id_tpregunta]],[[id_capitulo]],[[id_formato]],[[id_conjunto_pregunta]],[[id_version]]) VALUES (:valor, :idconjrpta, :idpregunta, :idtpregunta, :idcapitulo, :idformato,:idconjprta,:idversion)";
        }else{
            $g_sql="UPDATE $tableRpta SET [[ra_fecha]] = :valor,[[id_conjunto_respuesta]] = :idconjrpta,[[id_pregunta]] = :idpregunta ,[[id_tpregunta]] = :idtpregunta,[[id_capitulo]] = :idcapitulo,[[id_formato]] = :idformato,[[id_conjunto_pregunta]] = :idconjprta,[[id_version]] = :idversion WHERE [[id_respuesta]] = ".$_idrespuesta;
        }
