		...
		<div id="primaryContentContainer">
			<div id="primaryContent">
				...
				<p>ANOTACION: Antes de iniciar se debe tener creada la base de datos ver <a href='createbd.php'>Crear BD</a>
                                <p>Por orden del codigo se tranfieren todos los modelos a la carpeta common, para recrear el ejercicio en las casillas
                                    Model Class reemplazar "frontend" por "common"; y al crear el modelo en Model Generator, asignar a la casilla namespace "common\models".</p>
				...
				<ol>
					...
					<blockquote>
						<?= highlight_file('../../../common/models/wiki/Clientesprueba.php');	?>
					</blockquote>
