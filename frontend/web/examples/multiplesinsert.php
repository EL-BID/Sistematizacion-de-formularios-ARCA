...
<div id="outer">
	...
	<div id="menu">
		<h2>Componente Múltiples Tablas / Múltiples Insert</h2>
		<p>Módulo: Javascript</p>
		<ul>
            <li><a href="../index.php?r=proyectos" class="colora">Demo</a>
			<li><a href="#1">Creación de Modelos</a></li>
			<li><a href="#2">Creación del CRUD y Modificaciones</li>
            <li><a href="#3">SQL<a href="sql/public_proyectos.sql">Descargar</a></li>
		</ul>
	</div>
	<div id="content">
		<div id="primaryContentContainer">
			<div id="primaryContent">
				...
				<p>Clase YII: Se realiza con el CRUD ARCA</p>
				...
				<a name="1">
					...
					<ol>
						<li>Proyectos: A traves del modelo GII ARCA se crea el modelo Proyectos como lo muestra la imagen asociado a la tabla proyectos,
                                                    ...
                                                    Modelo Proyecto:
							<blockquote>
									<?= highlight_file('../../../common/models/wiki/Proyectos.php');	?>
							</blockquote>

                                                     Modelo Proyectopry:
							<blockquote>
									<?= highlight_file('../../../common/models/wiki/Proyectospry.php');	?>
							</blockquote>
						</li>
						...
						<li>Ciudadesp: El modelo ciudadesp se realiza para hacer el llamado en getCiudadesDropdown de la tabla ciudadesp.
                                                    ...
                                                    Modelo Ciudadesp:
                                                        <blockquote>
									<?= highlight_file('../../../common/models/wiki/Ciudadesp.php');	?>
							</blockquote>

                                                    Modelo Ciudadesppry:
                                                        <blockquote>
									<?= highlight_file('../../../common/models/wiki/Ciudadesppry.php');	?>
							</blockquote>
						</li>

                                                <li>Ciudadesproyectos: El modelo ciudadesproyectos realiza el llamado a la tabla ciudadesproyecto.
							<blockquote>
									<?= highlight_file('../../../common/models/wiki/Ciudadesproyectos.php');	?>
							</blockquote>

                                                        <blockquote>
									<?= highlight_file('../../../common/models/wiki/Ciudadesproyectospry.php');	?>
							</blockquote>
						</li>
					</ol>
				...
				<a name="2">
					<h3>Creación del CRUD y Modificaciones</h3>
                                </a>
