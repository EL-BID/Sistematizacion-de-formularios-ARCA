	...
	<div id="content">
		<div id="primaryContentContainer">
			<div id="primaryContent">
				...
				<h2>Componente Autcomplete:</h2>
				<p>Clase: yii\jui\AutoComplete</p>
				<p>Clase Javascript: use yii\web\JsExpression </p>
				<ul>
					<li><a href="#0">Vista Base</a></li>
					<li><a href="#1">Vista Formulario Create</a><a href="../index.php?r=clientesauto/create" class="colora">Demo</a></li>
					<li><a href="#1">Vista Formulario Update</a></li>
				</ul>
