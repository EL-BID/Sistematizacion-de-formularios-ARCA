...
<div id="outer">
	...
	<div id="menu">
		<ul>
			<li class="first"><a href="#" accesskey="1" title="">Generación Word</a></li>
		</ul>
	</div>
	<div id="content">
		<div id="primaryContentContainer">
			<div id="primaryContent">
				...
				<h2>Creación de Word</h2>
				<p>Clase: common\general\documents\genWord</p>
				<ul>
					<li><a href="#1">Gneración Word HTML </a><a href="../index.php?r=documentoword/create" class="colora" target='blank'>Demo</a></li>
