...
<div class="cda-solicitud-informacion-create">
    ...
    <?= $this->render('_formdatosalida', [
        'model' => $model,'actividadactual'=>$actividadactual,'listinfofaltante'=>$listinfofaltante,'listtiporeporte'=>$listtiporeporte,
        'listtipoatencion'=>$listtipoatencion,'ps_cproceso'=>$ps_cproceso,'listadoscda'=>$listadocdas,'listadodemarcacion'=>$listadodemarcacion,'listadocentro'=>$listadocentro,
