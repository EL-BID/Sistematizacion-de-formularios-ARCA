...
$this->title = $model->id_subtfuente;
$this->params['breadcrumbs'][] = ['label' => 'Cda Subtipo Fuentes', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="cda-subtipo-fuente-view">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Actualizar', ['update', 'id' => $model->id_subtfuente], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Borrar', ['delete', 'id' => $model->id_subtfuente], [
