        ...
        <table class="table table-bordered">
            ...
            <?php $form = ActiveForm::begin(['options' => [
             ...
             <?= $form->field($model, 'id_demarcacion')->dropDownList(\yii\helpers\ArrayHelper::map(
                                    $listadodemarcacion,'id_demarcacion','nombre_demarcacion'),['prompt'=>'Indique Demarcacion']
                               ) ?> 
     
            <?= $form->field($model, 'cod_centro_atencion_ciudadano')->dropDownList(\yii\helpers\ArrayHelper::map(
