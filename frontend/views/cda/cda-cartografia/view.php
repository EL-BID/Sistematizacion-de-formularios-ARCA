...
$this->title = $model->id_cartografia;
$this->params['breadcrumbs'][] = ['label' => 'Cda Cartografias', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="cda-cartografia-view">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Actualizar', ['update', 'id' => $model->id_cartografia], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Borrar', ['delete', 'id' => $model->id_cartografia], [
