...
$this->title = $model->id_tselect;
$this->params['breadcrumbs'][] = ['label' => 'Ps Tipo Selects', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="ps-tipo-select-view">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Actualizar', ['update', 'id' => $model->id_tselect], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Borrar', ['delete', 'id' => $model->id_tselect], [
