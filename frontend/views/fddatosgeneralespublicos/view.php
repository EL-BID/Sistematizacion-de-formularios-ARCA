...
$this->title = $model->id_datos_generales_publicos;
$this->params['breadcrumbs'][] = ['label' => 'Fd Datos Generales Publicos', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="fd-datos-generales-publicos-view">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Update', ['update', 'id' => $model->id_datos_generales_publicos], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Delete', ['delete', 'id' => $model->id_datos_generales_publicos], [
