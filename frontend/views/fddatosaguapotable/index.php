...
/* @var $searchModel common\models\poc\FdDatosAguaPotableSearch */
...
?>
<div class="fd-datos-agua-potable-index">
 ...
 <div class="aplicativo">
     <p>
        ...
        ['value' => Url::to(['fddatosaguapotable/createdetcapitulo',
                            'id_fmt' => $id_fmt,
...
//            'id_datos_agua_potable',
            'comunidad',
            'viviendas_existentes',
            'viviendas_agua_potable',
            'viviendas_medidores',
            ...
            [
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) use ($id_fmt,$id_version,$id_conj_prta,$id_cnj_rpta,$id_capitulo,$id_prta,$id_rpta,$nom_prta,$numerar,$migadepan,$estado,$capitulo,$provincia,$cantones,$parroquias,$periodos,$antvista,$focus) {
                        $urlup = Url::toRoute(['fddatosaguapotable/updatedetcapitulo',
                                                        'id' => $model->id_datos_agua_potable,
                                                        'id_fmt' => $id_fmt,
                                                        'id_version' => $id_version,
                                                        'id_conj_prta' => $id_conj_prta,
                                                        'id_cnj_rpta' => $id_cnj_rpta,
                    ...
                    }, //Primera columna encontrada id_datos_agua_potable
                    'delete' => function ($url, $model) use ($id_fmt,$id_version,$id_conj_prta,$id_cnj_rpta,$id_capitulo,$id_prta,$id_rpta,$nom_prta,$numerar,$migadepan,$estado,$capitulo,$provincia,$cantones,$parroquias,$periodos,$antvista,$focus) {
                        $url2 = Url::toRoute(['fddatosaguapotable/deletep',
                                                        'id' => $model->id_datos_agua_potable,
                                                        'id_fmt' => $id_fmt,
                                                        'id_version' => $id_version,
                                                        'id_conj_prta' => $id_conj_prta,
